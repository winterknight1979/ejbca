...
public final class FixEndOfBrokenXML {
  ...
  /**
   * Fixes XML with lost characters in the end. It can fix the XML if less
   * characters than the length of a tail that allways is the same is lost.
   *
   ...
   */
  public static String fixXML(
      final String xml, final String tag, final String tail) {
