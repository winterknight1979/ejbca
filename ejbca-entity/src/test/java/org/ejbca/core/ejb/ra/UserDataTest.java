 ...
 *
 * @version $Id: UserDataTest.java 25003 2017-01-13 09:46:34Z anatom $
 */
...
public class UserDataTest {
  ...
  public void test01UserPassword() throws Exception {
    ...
    // Now check that we can still use old password hashes transparently using
    // the old fixed sha1 hash of foo123
    data.setPasswordHash("3b303d8b0364d9265c06adc8584258376150c9b5");
    assertEquals(
        "3b303d8b0364d9265c06adc8584258376150c9b5", data.getPasswordHash());
    assertFalse(data.comparePassword("bar123"));
    assertTrue(data.comparePassword("foo123"));
    ...
    assertEquals(
        "OBF:1z7a1vnw1v251uo71unr1v291vn61z7s", data.getClearPassword());
  ...
  public void test02UserDataVOToEndEntityInformation() throws Exception {
    ...
    data.setType(
        new EndEntityType(
            EndEntityTypes.ENDUSER, EndEntityTypes.ADMINISTRATOR));
