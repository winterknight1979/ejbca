 ...
 *
 * @version $Id: MultiGroupPublisherBuilder.java 30234 2018-10-26 15:51:27Z
 *     andrey_s_helmes $
 */
public class MultiGroupPublisherBuilder {
  ...
  /**
   * Sets the flags 'Keep published in queue', 'Only use in queue', 'Use queue
   * for certificates' and 'Use queue for CRLs' to true.
   *
   * @return instance of this builder.
   */
  public MultiGroupPublisherBuilder withAllFlagsToTrue() {
    return this.keepPublishedInQueue(true)
        .onlyUseQueue(true)
  ...
  /**
   * Sets the flags 'Keep published in queue', 'Only use in queue', 'Use queue
   * for certificates' and 'Use queue for CRLs' to false.
   *
   * @return instance of this builder.
   */
  public MultiGroupPublisherBuilder withAllFlagsToFalse() {
    return this.keepPublishedInQueue(false)
        .onlyUseQueue(false)
  ...
  /**
   * Adds a new publisher group to the end as a TreeSet represented by input
   * collection.
   *
   * @param publisherIds a collection of publisher ids to add as a single set.
   * @return instance of this builder.
   */
  public MultiGroupPublisherBuilder addPublisherGroup(
