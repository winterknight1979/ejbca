 ...
 *
 * @version $Id: AddEndEntityApprovalRequest.java 27740 2018-01-05 07:24:53Z
 *     mikekushner $
 */
public class AddEndEntityApprovalRequest extends ApprovalRequest {
  ...
  public void execute(
    ...
    try {
      endEntityManagementSession.addUserAfterApproval(
          getRequestAdmin(), userdata, clearpwd, lastApprovingAdmin);
    } catch (EndEntityExistsException e) {
      throw new ApprovalRequestExecutionException(
          "Error, user already exist", e);
      ...
      throw new EJBException(
          "This WaitingForApprovalException should never happen", e);
      ...
      throw new ApprovalRequestExecutionException(
          "Failed adding user:" + e.getErrorCode() + e.getMessage(), e);
  ...
  public List<ApprovalDataText> getNewRequestDataAsText(
    ...
    retval.add(
        new ApprovalDataText("USERNAME", userdata.getUsername(), true, false));
    retval.add(
        new ApprovalDataText(
            "SUBJECTDN",
            CertTools.stringToBCDNString(userdata.getDN()),
            true,
            false));
    retval.add(
        getTextWithNoValueString(
            "SUBJECTALTNAME", userdata.getSubjectAltName()));
    String dirattrs =
    ...
    retval.add(
        new ApprovalDataText(
            "KEYRECOVERABLE",
            userdata.getKeyRecoverable() ? "YES" : "NO",
            true,
            true));
    retval.add(
        new ApprovalDataText(
            "SENDNOTIFICATION",
            userdata.getSendNotification() ? "YES" : "NO",
            true,
            true));
    return retval;
  }
  ...
  public List<ApprovalDataText> getNewRequestDataAsText(
    ...
    retval.add(
        ApprovalRequestHelper.getTokenName(
            hardTokenSession, userdata.getTokenType()));
    retval.add(
        getTextWithNoValueString(
