...
public class UsernameGeneratorParams {
  ...
  public void setDNGeneratorComponent(final String generatorComponent) {
  ...
  public void setRandomGeneratorType(final String randomGeneratorType) {
  ...
  public void setRandomNameLength(final int randomNameLength) {
  ...
  public void setRandomPrefixLength(final int randomPrefixLength) {
