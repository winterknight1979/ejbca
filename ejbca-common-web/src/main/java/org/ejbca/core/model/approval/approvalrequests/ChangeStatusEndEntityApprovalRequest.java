 ...
 *
 * @version $Id: ChangeStatusEndEntityApprovalRequest.java 24892 2016-12-13
...
public class ChangeStatusEndEntityApprovalRequest extends ApprovalRequest {
  ...
  public boolean isAllowedTransition() {
    boolean ret = false;
    // Allow Keyrecovery transitions until keyrecovery approvals have been
    // implemented.
  ...
  public void execute(
    ...
    try {
      ...
      throw new ApprovalRequestExecutionException(
          "User with username + " + username + " doesn't exist.", e);
  ...
  public List<ApprovalDataText> getNewRequestDataAsText(
    ...
    retval.add(
        new ApprovalDataText(
            "STATUS",
            EndEntityConstants.getTranslatableStatusText(newstatus),
            true,
            true));
    return retval;
  }
  ...
  public List<ApprovalDataText> getOldRequestDataAsText(
    ...
    retval.add(
        new ApprovalDataText(
            "STATUS",
            EndEntityConstants.getTranslatableStatusText(oldstatus),
            true,
            true));
    return retval;
  }
