...
/**
 * Base interface for DNS name validators. All DNS name validators must
...
public interface DnsNameValidator extends Validator, DynamicUiModelAware {
   ...
   * @return an Entry where key is the final validation result, true or false,
   *     and the value is a list is messages corresponding to domain names
   *     passed as varargs, messages can include both success and failure
