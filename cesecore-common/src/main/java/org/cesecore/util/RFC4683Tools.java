...
public final class RFC4683Tools {
	...
	/**
	 * Gets the allowed hash algorithm object identifiers (@see <a href="https://tools.ietf.org/html/rfc4683#section-4.3">RFC4683 sec. 4.3</a>).
	 ...
	 * @return the RFC4683 SIM GeneralName (@see <a href="https://tools.ietf.org/html/rfc4683#section-4.3">RFC4683 sec. 4.3</a>).
	 */
