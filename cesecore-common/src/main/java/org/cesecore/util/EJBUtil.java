...
/**
 * Helper methods for EJB calls, currently only wrapping and unwrapping
 * certificates in a way such that they can always be deserialized.
 *
...
public final class EJBUtil {
   ...
   * Remote EJB even if it's supported only by the BC provider.
   *
  ...
  /**
   * Wraps a KeyPair object in a KeyPairWrapper, which can be sent over Remote
   * EJB even if it's supported only by the BC provider.
   *
