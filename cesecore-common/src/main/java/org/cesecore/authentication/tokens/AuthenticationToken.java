 ...
 *
 * The Sets of Principals and credentials contained within this class will
...
public abstract class AuthenticationToken implements Serializable {
    ...
    /**
     * This method will take an <code>AccessUserAspectData</code> entity
     * and return whether or not it matches to this AuthenticationToken. Will
     ...
     * @throws AuthenticationFailedException if any
     *         authentication errors were encountered during process
     */
    ...
    /**
     * Default way of returning the user information of the user(s)
     * this authentication token belongs to.
     * This should never return sensitive information,
     * since it is used in logging (CESeCore.FAU_GEN.1.2).
    ...
    /**
     * @param tokenType String a String from an AccessMatchValue
     *         derivative that matches this token type.
     * @return true if the given value matches this AuthenticationToken's
     *         inherent token type.
     */
    ...
    /**
     *
     * @return the first available AccessMatchValue inherent
     *         to the implementing token type.
     */
     ...
     * @return the enum implementing AccessMatchValue that matches
     *         the given numeric value from the database.
     */
    ...
    /**
     * Returns the preferred match key for this type of
     * authentication token. E.g. serial number for X.509 tokens
     * If not applicable to this authentication token,
     * then it returns {@link #NO_PREFERRED_MATCH_KEY}.
     * @return Key
     */
     ...
     * E.g. the serial number of X.509 tokens.
     * <b>Note:</b> For performance reasons, this value must
     ...
     * @return
     *    a hex-encoded string of the hash over all the provided arguments */
        ...
        try {
            ...
            for (final Object argument : arguments) {
                if (argument instanceof byte[]) {
                    ...
                    messageDigest.update((String.valueOf(argument)
    ...
    /** @return a String that is guaranteed to be unique across all
     * AuthenticationTokens (and will be different if nested with
     * different AuthenticationTokens). */
