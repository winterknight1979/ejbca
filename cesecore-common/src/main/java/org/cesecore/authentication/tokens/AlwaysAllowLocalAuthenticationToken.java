...
/**
 * An authentication token that always matches the provided
 * AccessUserAspectData if the AuthenticationToken was created
 * in the same JVM as it is verified.
 *
 * Example usage: AuthenticationToken authenticationToken
 *     = new AlwaysAllowLocalAuthenticationToken("Internal function abc");
 *
 * @version
 *   $Id: AlwaysAllowLocalAuthenticationToken.java 27631
 *   2017-12-21 14:12:37Z anatom $
 */
public class AlwaysAllowLocalAuthenticationToken
    ...
    public AlwaysAllowLocalAuthenticationToken(final String username) {
        super(new HashSet<Principal>(Arrays.asList(
                new UsernamePrincipal(username))), null);
    }
    ...
    /** Do not use since EJBCA 6.8. Kept for backwards compatibility reasons
     *  to de-serialize ApprovalRequests. See ECA-6442 */
    ...
    private enum InternalMatchValue implements AccessMatchValue {
        ...
        private static final String TOKEN_TYPE
            = "AlwaysAllowAuthenticationToken";
