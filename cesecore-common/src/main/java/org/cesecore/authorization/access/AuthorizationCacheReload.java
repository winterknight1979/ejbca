 ...
 *  org.cesecore.authorization.cache.AccessTreeUpdateSessionBean#signalForAccessTreeUpdate() in cesecore-ejb.
 * 
 * Currently we can't use JEE events, because it requires that we use CDI.
 * Instead the method org.cesecore.authorization.cache.AccessTreeUpdateSessionLocal.addReloadEvent(AuthorizationCacheReloadListener) can be used
 * 
