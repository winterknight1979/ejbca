...
public enum AccessMatchType {
    ...
    TYPE_EQUALCASE(1000),
    /**
     * Case insensitive. Can be used for textual match values, e.g.
     * a Common Name.
     ...
     * find
     * these in the database in old installations, even though we
     * don't want to use
     * them. These have no meaning whatsoever in newer installations
     * of EJBCA, and
     * can safely be removed from the database if found (unless we ne
     * ed to run an
     * old installation in parallel).
     *
     * Public Web User
     * @deprecated since v4
     */
