 ...
 *
 * @version $Id: ExternalScriptsConfiguration.java 27691 2017-12-29 14:24:12Z
 *     bastianf $
 */
public interface ExternalScriptsConfiguration {
   ...
   * used.
   *
   * @return true if the the whitelist retrieved from {@link
   *     #getExternalScriptsWhitelist()} should be used
   */
  boolean getIsExternalScriptsWhitelistEnabled();

  /**
   * Sets a value indicating whether a whitelist for external commands should be
   * used.
   *
