 ...
 *
 * <p>Roughly based on PatternLogger.java 8663 2010-02-17 10:42:41Z anatom from
 * EJBCA
 *
...
public abstract class PatternLogger implements Serializable {
  ...
  private Matcher getMatcher() {
    if (this.m == null) {
      // We have to instantiate the Matcher in the class and can not have it as
      // an instance variable.
      // This is because we are sending this object to a remote EJB (at least in
      // system tests)
  ...
  private Logger getLogger() {
    if (this.logger == null) {
      // We have to instantiate the logger in the class and can not have it as
      // an instance variable.
      // This is because we are sending this object to a remote EJB (at least in
      // system tests) and org.apache.log4j.Logger is not serializable.
  ...
  public void flush() {
    if (doLogging) {
      ...
      getLogger()
          .debug(output); // Finally output the log row to the logging device
    }
  }
