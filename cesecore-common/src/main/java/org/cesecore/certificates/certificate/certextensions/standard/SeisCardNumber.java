...
/**
 * The Card Number is a PrintableString that shall respond to the number printed
 * on a card on which the certificate is stored. The extension is specified in
 * the the Seis document SS 614331 chapter 4.3 and has OID 1.2.752.34.2.1
 *
 * <p>CardNumber EXTENSION ::= { SYNTAX CardNumber IDENTIFIED BY id-seis-pe-cn}
 * -- id-seis-pe-cn is defined in Annex A CardNumber ::= PrintableString
 *
 * @version $Id: SeisCardNumber.java 22092 2015-10-26 13:58:55Z mikekushner $
 */
