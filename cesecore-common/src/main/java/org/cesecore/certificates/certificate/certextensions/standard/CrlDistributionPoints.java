 ...
 * of this extension.
 *
 * @version $Id: CrlDistributionPoints.java 23316 2016-04-28 19:03:37Z jeklund $
 */
public class CrlDistributionPoints extends StandardCertificateExtension {
  ...
  public ASN1Encodable getValue(
    ...
    // CRL issuer works much like Dist point URI. If separated by ; it is put in
    // the same global distPoint as the URI,
    // if there is more of one of them, the one with more is put in an own
    // global distPoint.
    final ArrayList<GeneralNames> issuers = new ArrayList<GeneralNames>();
    if (StringUtils.isNotEmpty(crlissuer)) {
      final StringTokenizer tokenizer =
          new StringTokenizer(crlissuer, ";", false);
