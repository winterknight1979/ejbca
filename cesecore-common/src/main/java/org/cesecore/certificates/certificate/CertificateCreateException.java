...
/**
 * An exception thrown when a serious error happens creating a certificate. If
 * this happens any transaction depending on this should be rolled back.
 *
 * @version $Id: CertificateCreateException.java 26230 2017-08-07 12:36:32Z
 *     anatom $
 */
...
public class CertificateCreateException extends CesecoreException {
   ...
   */
  public CertificateCreateException(final String msg) {
    super(msg);
  }
   ...
   */
  public CertificateCreateException(final Exception e) {
    super(e);
  }
   ...
   */
  public CertificateCreateException(
          final ErrorCode errorCode, final Exception e) {
    super(errorCode, e);
  }
   ...
   * @param msg the detail message.
   */
  public CertificateCreateException(final String msg, final Exception e) {
    super(msg, e);
  }
   ...
   */
  public CertificateCreateException(
          final  ErrorCode errorCode, final String msg) {
    super(errorCode, msg);
  }
}
