...
public class IllegalNameException extends CesecoreException {
   ...
   * constructor in baseclass <code>CesecoreException</code>.
   *
   ...
   * same constructor in baseclass <code>CesecoreException</code>.
   *
  ...
  /**
   * Constructor used to create exception with a message and an embedded
   * exception. Calls the same constructor in baseclass <code>CesecoreException
   * </code>.
   *
