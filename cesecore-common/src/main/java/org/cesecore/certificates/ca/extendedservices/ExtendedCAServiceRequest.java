 ...
 *
 * @version $Id: ExtendedCAServiceRequest.java 17625 2013-09-20 07:12:06Z
 *     netmackan $
 */
public abstract class ExtendedCAServiceRequest implements Serializable {
   ...
   * I.e. the type must be the same that was used in ExtendedCAServiceInfo when
   * creating the CA service.
   *
   * @return type flag, for example
   *     ExtendedCAServiceInfo.TYPE_CMSEXTENDEDSERVICE
   */
