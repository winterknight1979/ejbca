 ...
 *
 * @version $Id: SernoGenerator.java 31882 2019-03-18 13:50:56Z anatom $
 */
public interface SernoGenerator {
  ...
  /**
   * Sets an optional seed needed by the serno generator. This can be different
   * things, for a sequential generator it can for instance be the first number
   * to be generated and for a random generator it can be a random seed. The
   * constructor may seed the generator enough so this method may not be
   * nessecary to call.
   *
   ...
   * Usually a default value is provided for your serial number generator. This
   * can be used to override/change default values. Usage must consider
   * multi-threaded behavior.
   *
   * @param algo an (optional) algorithm for a serial number generator
   *     implementation
