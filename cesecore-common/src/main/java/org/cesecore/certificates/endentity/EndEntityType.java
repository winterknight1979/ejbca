...
/**
 * This class basically wraps an int value, manipulating it using various
 * EndEntityTypes.
 *
 * @version $Id: EndEntityType.java 19902 2014-09-30 14:32:24Z anatom $
 */
public class EndEntityType implements Serializable {
  ...
  /**
   * Creates an amalgam of all types given as parameters using binary OR on
   * their hex values.
   *
