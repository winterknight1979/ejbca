...
/**
 * This class contains Google's CT policy as specified in "Certificate
 * Transparency in Chrome" from May 2016. The policy document can be found here:
 * https://goo.gl/cZZqLw
 *
 * @version $Id: GoogleCtPolicy.java 27474 2017-12-07 19:53:25Z samuellb $
 */
public class GoogleCtPolicy implements Serializable {
  ...
  /**
   * Validate the CT policy stored in this object. Currently checking the
   * following:
   *
   * <ul>
   *   <li>Ensure the number of CT logs are all greater than zero.
   * </ul>
   *
   * @return boolean
   */
  ...
  /**
   * Set the minimum number of SCTs required for certificates with a lifetime of
   * less than 15 Months.
   *
  ...
  /**
   * Set the minimum number of SCTs required for non EV-certificates with a
   * lifetime of more than 39 Months.
   *
   * @param value a number of SCTs
   */
  ...
  /**
   * Get the minimum number of SCTs required for certificates with a lifetime of
   * less than 15 Months.
   *
  ...
  /**
   * Get the minimum number of SCTs required for non EV-certificates with a
   * lifetime of more than 39 Months.
   *
   * @return a number of SCTs
   */
  ...
  /**
   * @return the number of breakpoints (i.e. indices to
   *     getMinSctsByIndex/getLessThanMonthsByIndex)
   */
