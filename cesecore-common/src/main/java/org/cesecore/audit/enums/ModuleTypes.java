...
/**
 * When doing secure audit log it is necessary to identify from which module a
 * security audit event originates.
 *
 * <p>A modules is a group of related functionality. This class contains the
