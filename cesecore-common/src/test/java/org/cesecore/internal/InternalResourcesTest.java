...
/**
 * @version $Id: InternalResourcesTest.java 25823 2017-05-10 06:57:54Z anatom $
 */
public class InternalResourcesTest {
  ...
  public void testGetLocalizedMessageString() {
    ...
    assertEquals(
        "Test en-US                        ",
        intres.getLocalizedMessageCs("raadmin.testmsg").toString());
  ...
  public void testGetLocalizedMessageStringObject() {
    ...
    assertEquals(
        "Test 1 3 hi true bye message 1 ",
        intres
            .getLocalizedMessageCs(
                "raadmin.testparams",
                Long.valueOf(1),
                Integer.valueOf(3),
                "hi",
  ...
  public void testMessageStringWithExtraParameter() {
    ...
    assertEquals(
        "Test sv-SE",
        intres
            .getLocalizedMessageCs("raadmin.testmsgsv", "foo $bar \\haaaar")
            .toString());
  }
  ...
  public void testMessageStringWithRecursive() {
    ...
    String res =
        intres.getLocalizedMessage(
            ...
            "bye");
    assertEquals(
        "Test recurse recurse recurse recurse recurse recurse recurse recurse"
            + " recurse recurse recurse recurse recurse recurse recurse"
            + " recurse recurse recurse recurse recurse {0} 3  true bye"
            + " message {0} ",
        res);
  }
}
