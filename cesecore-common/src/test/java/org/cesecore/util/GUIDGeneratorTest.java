...
/**
 * Tests generation of GUIds, make sure there are no collisions very easily at
 * least.
 *
...
public class GUIDGeneratorTest {
  ...
  public void testGenerateGUIDs() throws Exception {
    ...
    for (int j = 1; j < 500001; j++) {
      // Ensure we don't generate all GUIDs within the same millisecond, so
      // pause 1ms for every 1000 GUIDs generated.
      // This should be more "real world", as we will probably not add more than
      // 1000 records to a DB during 1 single millisecond
      if (j % 1000 == 0) {
      ...
      if (map.put(guid, guid) != null) {
        ...
        //                    log.warn("Number of guids produced before
        // duplicate: "+j);
