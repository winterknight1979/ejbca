...
public class LookAheadObjectInputStreamTest {
    ...
    public void testDeserializingPrimitiveTypes() throws Exception {
        ...
        try (final LookAheadObjectInputStream laois = new LookAheadObjectInputStream(new ByteArrayInputStream(serializedData))) {
            ...
            assertEquals("Data 2 corrupted during testDeserializingPrimitiveTypes", (int) 2, (int) laois.readObject());
            assertEquals("Data 3 corrupted during testDeserializingPrimitiveTypes", (long) 3, (long) laois.readObject());
            assertEquals("Data 4 corrupted during testDeserializingPrimitiveTypes", (float) 4, (float) laois.readObject(), 0);
            assertEquals("Data 5 corrupted during testDeserializingPrimitiveTypes", (double) 5, (double) laois.readObject(), 0);
            ...
            assertEquals("Data 15 corrupted during testDeserializingPrimitiveTypes", "String", ((String) laois.readObject()));
    ...
    public void testDeserializingExtendedClassesWithoutAllowingSuperclass() throws Exception {
        ...
        try (final LookAheadObjectInputStream laois = new LookAheadObjectInputStream(new ByteArrayInputStream(serializedData))) {
            laois.setAcceptedClasses(new HashSet<Class<? extends Serializable>>(Arrays.asList(GoodExtendedExtendedClass.class)));
            laois.setEnabledMaxObjects(false);
        ...
        try (final LookAheadObjectInputStream laois = new LookAheadObjectInputStream(new ByteArrayInputStream(serializedData))) {
            laois.setAcceptedClasses(new HashSet<Class<? extends Serializable>>(Arrays.asList(GoodExtendedExtendedClass.class, GoodExtendedClass.class)));
            laois.setEnabledMaxObjects(false);
            laois.setEnabledSubclassing(false);
            laois.readObject();
            fail("SecurityException should have been thrown.");
        ...
        try (final LookAheadObjectInputStream laois = new LookAheadObjectInputStream(new ByteArrayInputStream(serializedData))) {
            laois.setAcceptedClasses(new HashSet<Class<? extends Serializable>>(Arrays.asList(GoodExtendedExtendedClass.class, GoodExtendedClass.class, GoodAbstractClass.class)));
            laois.setEnabledMaxObjects(false);
            laois.setEnabledSubclassing(false);
    ...
    public void testDeserializingWithNonWhitelistedField() throws Exception {
        ...
        try (final LookAheadObjectInputStream laois = new LookAheadObjectInputStream(new ByteArrayInputStream(serializedData))) {
            laois.setAcceptedClasses(new HashSet<Class<? extends Serializable>>(Arrays.asList(BadDog.class)));
            laois.setEnabledMaxObjects(false);
            laois.setEnabledSubclassing(true);
