...
/**
 * @version $Id: BasicCertificateExtensionTest.java 29875 2018-09-13 10:39:12Z
 *     aminkh $
 */
public class BasicCertificateExtensionTest {
  ...
  public void test01NullBasicExtension() throws Exception {
    ...
    ASN1Encodable value =
        getObject(baseExt.getValueEncoded(null, null, null, null, null, null));
  ...
  public void test02IntegerBasicExtension() throws Exception {
    ...
    assertTrue(
        ((ASN1Integer) value).toString(),
        ((ASN1Integer) value).toString().equals("1234"));
    assertTrue(baseExt.getOID().equals("1.2.3"));
    assertTrue(baseExt.getId() == 1);
    assertFalse(baseExt.isCriticalFlag());
  ...
  public void test03BitStringBasicExtension() throws Exception {
    ...
    assertTrue(value.getClass().toString(), value instanceof DERBitString);
    new BigInteger(
        ((DERBitString) value).getBytes()); // Will throw if value is wrong
  ...
  public void test04BooleanBasicExtension() throws Exception {
    ...
    assertTrue(
        ((ASN1Boolean) value).toString(),
        ((ASN1Boolean) value).toString().equals("TRUE"));
    assertTrue(baseExt.getOID().equals("1.2.3"));
    assertTrue(baseExt.getId() == 1);
    assertFalse(baseExt.isCriticalFlag());
    ...
    assertTrue(
        ((ASN1Boolean) value).toString(),
        ((ASN1Boolean) value).toString().equals("FALSE"));
  ...
  public void test06PritableStringExtension() throws Exception {
    ...
    ASN1Encodable value =
        getObject(baseExt.getValueEncoded(null, null, null, null, null, null));
    assertTrue(
        value.getClass().toString(), value instanceof DERPrintableString);
    assertTrue(
        ((DERPrintableString) value).toString(),
        ((DERPrintableString) value)
            .toString()
            .equals("This is a printable string"));
  ...
  public void test09OidExtension() throws Exception {
    ...
    ASN1Encodable value =
        getObject(baseExt.getValueEncoded(null, null, null, null, null, null));
    assertTrue(
        value.getClass().toString(), value instanceof ASN1ObjectIdentifier);
    assertTrue(
        ((ASN1ObjectIdentifier) value).getId(),
  ...
  public void test10SequencedExtension() throws Exception {
    ...
    props.put(
        "encoding",
        "DERUTF8STRING "); // Also test that we ignore spaces in the end here
    props.put("nvalues", "3");
  ...
  public void test11IA5StringExtension() throws Exception {
    ...
    assertEquals(
        "This is a printable string", ((DERIA5String) value).toString());
   ...
   *
   * <p>There should be an exception if no value was specified in
   * ExtendedInformation. But it should succeed if an value was specified in
   * ExtendedInformation.
   *
   * @throws Exception fail
   */
  ...
  public void test13DynamicTrueNoStatic() throws Exception {
    ...
    userData
        ...
        .setExtensionData("1.2.3", "The value 123");
    ASN1InputStream in =
        new ASN1InputStream(
            new ByteArrayInputStream(
                baseExt.getValueEncoded(
                    userData, null, null, null, null, null)));
    try {
      ASN1Encodable value1 = in.readObject();
      assertTrue(
          value1.getClass().toString(), value1 instanceof DERPrintableString);
   ...
   *
   * <p>The static value should be used if no value was specified in
   * ExtendedInformation. The value from ExtendedInformation should be used if
   * present.
   *
   * @throws Exception fail
   */
  ...
  public void test14DynamicTrueStatic() throws Exception {
    ...
    assertTrue(
        value1.getClass().toString(), value1 instanceof DERPrintableString);
    assertEquals(
        "The static value 123", ((DERPrintableString) value1).getString());

    // With value in userdata, that value is used
    userData
        .getExtendedInformation()
        .setExtensionData("1.2.3", "A dynamic value 123");
    in =
        new ASN1InputStream(
            new ByteArrayInputStream(
                baseExt.getValueEncoded(
    ...
    assertTrue(
        value1.getClass().toString(), value1 instanceof DERPrintableString);
    assertEquals(
        "A dynamic value 123", ((DERPrintableString) value1).getString());
  }

  /**
   * Test with dynamic=true and and a static value specified where nvalues are
   * used.
   *
   * <p>The static values should be used if no value was specified in
   * ExtendedInformation. The values from ExtendedInformation should be used if
   * present.
   *
   * @throws Exception fail
   */
  ...
  public void test15DynamicTrueStaticNvalues() throws Exception {
    ...
    userData
        .getExtendedInformation()
        .setExtensionData("1.2.3.value1", "A dynamic value 1");
    userData
        .getExtendedInformation()
        .setExtensionData("1.2.3.value2", "A dynamic value 2");
    userData
        .getExtendedInformation()
        .setExtensionData("1.2.3.value3", "A dynamic value 3");
    in =
        new ASN1InputStream(
            new ByteArrayInputStream(
                baseExt.getValueEncoded(
   ...
   *
   * <p>The static value should be used regardless of there was a value in
  ...
  public void test18DynamicValueValue() throws Exception {
    ...
    userData
        .getExtendedInformation()
        .setExtensionData("1.2.3.value", "The value 456");
    ASN1InputStream in =
        new ASN1InputStream(
            new ByteArrayInputStream(
                baseExt.getValueEncoded(
  ...
  public void test20CertExtensionEncoding() throws Exception {
    ...
    extgen.addExtension(
        new ASN1ObjectIdentifier(baseExt.getOID()),
    ...
    assertNotNull(ext);
    // Read the extension value, it's a DERIA5String wrapped in an
    // ASN1OctetString
    ASN1OctetString str = ext.getExtnValue();
    ASN1InputStream aIn =
        new ASN1InputStream(new ByteArrayInputStream(str.getOctets()));
