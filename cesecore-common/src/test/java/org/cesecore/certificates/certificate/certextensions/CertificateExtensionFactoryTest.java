 ...
 *
 * @version $Id: CertificateExtensionFactoryTest.java 21807 2015-09-08 10:32:40Z
 *     aveen4711 $
 */
public class CertificateExtensionFactoryTest {
  ...
  public void test02StandardCertificateExtensions() throws Exception {
    ...
    List<String> usedStdCertExt =
        profile.getUsedStandardCertificateExtensions();
    ...
    while (certStdExtIter.hasNext()) {
      ...
      CertificateExtension certExt =
          fact.getStandardCertificateExtension(oid, profile);
