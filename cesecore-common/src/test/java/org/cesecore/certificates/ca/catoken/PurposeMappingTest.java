...
public class PurposeMappingTest {
  ...
  public void test01KeyStringsEmpty() throws Exception {
    ...
    key =
        ks.getPurposeProperty(CATokenConstants.CAKEYPURPOSE_CERTSIGN_PREVIOUS);
    assertNull("Should return null, since we don't have it defined", key);
  ...
  public void test02KeyStringsSomeEmpty() throws Exception {
    ...
    // it's backed by a hashset so we really don't know the order, but this is
    // what it is in jdk 6...
  ...
  public void test03KeyStringsAll() throws Exception {
    ...
    // it's backed by a hashset so we really don't know the order, so make it
    // into a collection instead
