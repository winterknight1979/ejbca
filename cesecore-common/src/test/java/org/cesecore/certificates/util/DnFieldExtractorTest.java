...
public class DnFieldExtractorTest {
  ...
  public void test01CheckDnFields() throws Exception {
    ...
    final String description =
        extractor.getField(DNFieldExtractor.DESCRIPTION, 0);
    ...
    final String oi =
        extractor.getField(DNFieldExtractor.ORGANIZATIONIDENTIFIER, 0);
    if (DnComponents.enterpriseMappingsExist()) {
  ...
  public void test01CheckDirAttrFields() throws Exception {
    ...
    DNFieldExtractor extractor =
        new DNFieldExtractor(dn, DNFieldExtractor.TYPE_SUBJECTDIRATTR);
  ...
  public void test02CheckComplexDnFieldWithCommas() throws Exception {
    ...
    final String dn =
        "directoryName=serialNumber=12345678\\,description=This is a\\>"
            + " test/\\,name=abc123\\,2.5.4.65=Test1234";
    DNFieldExtractor extractor =
        new DNFieldExtractor(dn, DNFieldExtractor.TYPE_SUBJECTALTNAME);
    String value = extractor.getField(DNFieldExtractor.DIRECTORYNAME, 0);
    assertEquals(
        "serialNumber=12345678,description=This is a>"
            + " test/,name=abc123,2.5.4.65=Test1234",
        value);
