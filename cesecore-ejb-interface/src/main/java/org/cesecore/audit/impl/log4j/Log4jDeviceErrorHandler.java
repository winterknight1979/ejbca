...
/**
 * Custom wrapper for Log4J ErrorHandler, so we can check if logging was
 * successful or not.
 *
 * @version $Id: Log4jDeviceErrorHandler.java 18374 2014-01-16 13:13:34Z anatom
 *     $
 */
public class Log4jDeviceErrorHandler implements ErrorHandler {
  ...
  /**
   * @return true if this error handler has not been invoked since last call to
   *     this method.
   */
  public boolean isOk() {
    if (ok) {
