...
/**
 * An exception thrown when an error happens trying to import CRLs to the CRL
 * store. If this happens any transaction depending on this should be rolled
 * back.
 *
 * @version $Id: CrlImportException.java 24468 2016-10-06 09:30:38Z aveen4711 $
 */
...
public class CrlImportException extends CesecoreException {
   ...
   */
  public CrlImportException(final String msg) {
    super(msg);
  }
   ...
   */
  public CrlImportException(final Exception e) {
    super(e);
  }
   ...
   * @param msg the detail message
   */
  public CrlImportException(final String msg, final Exception e) {
    super(msg, e);
  }
}
