...
public interface CrlStoreSession {
   ...
   * @param deltaCRL true to get the latest deltaCRL, false to get the latest
   *     complete CRL
  ...
  /**
   * Retrieves the information about the latest CRL issued by this CA. Retrieves
   * less information than getLastCRL, i.e. not the actual CRL data.
   *
   * @param issuerdn the CRL issuers DN (CAs subject DN)
   * @param deltaCRL true to get the latest deltaCRL, false to get the latest
   *     complete CRL
   ...
   * @param deltaCRL true to get the latest deltaCRL, false to get the latest
   *     complete CRL
   * @return the highest CRL number of CRLs issued by issuerdn, or 0 if no CRLs
   *     were issued.
   */
   ...
   * @throws AuthorizationDeniedException (rollback) if admin was not authorized
   *     to store CRL
   */
  void storeCRL(
