 ...
 */
@Stateless(
    mappedName = JndiConstants.APP_JNDI_PREFIX + "AcmeOrderDataSessionRemote")
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class AcmeOrderDataSessionBean
    implements AcmeOrderDataSessionRemote, AcmeOrderDataSessionLocal {
  ...
  @Override
  public Set<AcmeOrderData> findByAccountId(final String accountId) {
    throw new UnsupportedOperationException(
        "ACME calls are only supported in EJBCA Enterprise");
  }

  @Override
  public Set<AcmeOrderData> findFinalizedAcmeOrdersByFingerprint(
      final String fingerprint) {
    throw new UnsupportedOperationException(
        "ACME calls are only supported in EJBCA Enterprise");
  }
