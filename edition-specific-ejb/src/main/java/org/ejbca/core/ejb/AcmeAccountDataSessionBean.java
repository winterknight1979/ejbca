 ...
 *
 * @version $Id: AcmeAccountDataSessionBean.java 27609 2017-12-20 15:55:45Z
 *     mikekushner $
 */
@Stateless(
    mappedName = JndiConstants.APP_JNDI_PREFIX + "AcmeAccountDataSessionRemote")
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class AcmeAccountDataSessionBean
    implements AcmeAccountDataSessionRemote, AcmeAccountDataSessionLocal {
  ...
  @Override
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public AcmeAccountData findByPublicKeyStorageId(
