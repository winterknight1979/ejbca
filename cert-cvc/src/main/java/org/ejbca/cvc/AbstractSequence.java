...
public abstract class AbstractSequence extends CVCObject {
  ...
  /**
   * Adds a subfield to this sequence, as above, but with the possibility to
   * overwrite an existing field with a new one.
   *
   * @param field the field to add
   * @param override true if an existing field should be overwritten, false if
   *     an exception should be thrown if the field already exists
   * @throws ConstructionException if the supplied field is not allowed in this
  ...
  @Override
  public int encode(final DataOutputStream pOut) throws IOException {
