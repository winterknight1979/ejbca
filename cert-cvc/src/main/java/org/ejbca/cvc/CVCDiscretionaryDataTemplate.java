...
/**
 * Represents the field 'Discretionary Data Template', which is used to wrap
 * certificate extensions. Described in the BSI TR-03110 Part 3 v2.2, page 89.
 *
...
public class CVCDiscretionaryDataTemplate extends AbstractSequence {
  ...
  /**
   * Constructor taking the individual fields. This constructor can be used
   * internally only.
   *
 ...
 * @throws ConstructionException fail
  ...
  /**
   * Constructor taking the individual fields. This constructor can be used with
   * custom OIDs.
   *
