 ...
 *
 * <p>At the moment this will deal with binary encoded CVC certificates. Only
 * one CVC certificate can be in the input stream passed. Bouncy Castle's
...
public class JDKCVCertificateFactory extends CertificateFactorySpi {
   ...
   */
  @Override
  public Certificate engineGenerateCertificate(final InputStream in)
  ...
  public Collection<Certificate> engineGenerateCertificates(
      final InputStream inStream) throws CertificateException {
  ...
  /** CRLs are not supported by CVC. Will always throw CRLException! */
  @Override
  public Collection<CRL> engineGenerateCRLs(final InputStream inStream)
      throws CRLException {
    throw new CRLException("CVC CertificateFactory can not create CRLs");
  }
}
