...
public class CVCertificateBody extends AbstractSequence {
  ...
  public CVCertificateBody(
      ...
      final CVCPublicKey publicKey,
      final HolderReferenceField holderReference,
      final CVCAuthorizationTemplate holderAuthorizationTemplate,
  ...
  private static CVCAuthorizationTemplate chat(
      final AuthorizationRole authRole, final AccessRights accessRight)
      throws ConstructionException {
    if (authRole == null) {
  ...
  public CVCertificateBody(
      ...
      final AccessRightEnum accessRight,
      final Date validFrom,
      final Date validTo)
      throws ConstructionException {
    this(
  ...
  public CVCAuthorizationTemplate getAuthorizationTemplate()
    ...
    return (CVCAuthorizationTemplate)
        getSubfield(CVCTagEnum.HOLDER_AUTH_TEMPLATE);
  }
   ...
   * @param holderReference Contains country code, holder mnemonic, and sequence
   *     number for the certificate holder.
   * @param authRole Authorization role, specifies whether the holder is a CVCA,
   *     domestic DVCA, foreign DVCA, or AT/ST/IS.
  ...
  public CVCertificateExtensions getCertificateExtensions()
      throws NoSuchFieldException {
    return (CVCertificateExtensions)
        getSubfield(CVCTagEnum.CERTIFICATE_EXTENSIONS);
  }
}
