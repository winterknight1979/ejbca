...
/**
 * A "Certificate Extensions" sequence in a CV certificate. It contains
 * CVCDiscretionaryDataTemplate objects.
 *
...
public class CVCertificateExtensions extends AbstractArray {
  ...
  /**
   * Constructor taking a list of certificate extensions (wrapped in
