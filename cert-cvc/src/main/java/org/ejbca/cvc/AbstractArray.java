...
/**
 * Represents a CVC sequence, i e contains one or more subfields. This variant
 * allows multiple objects of the same type. It preserves order of the objects.
 *
...
public abstract class AbstractArray extends AbstractSequence {
  ...
  @Override
  protected final CVCObject getSubfield(final CVCTagEnum fieldTag)
