 ...
 * @throws Exception fail
  ...
  public void testSecurityProvider() throws Exception {
    ...
    assertEquals(
        "Certificates as text differ", cvc.getAsText(), cert2.getAsText());
  ...
  public void testExternalCert() throws Exception {
    ...
    byte[] bytes =
        FileHelper.loadFile(
            new File("./src/test/resources/C_CZCVCADCZ000.cvcert"));
  ...
  private CVCertificate createTestCertificate(final AuthorizationRoleEnum role)
      throws Exception {
