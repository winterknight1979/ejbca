 ...
 *
 * @version $Id: RevokeCertificateCommand.java 25010 2017-01-13 16:14:28Z
 *     mikekushner $
 */
public class RevokeCertificateCommand extends BaseRaCommand {
...

  {
    ...
    registerParameter(
        new Parameter(
            ...
            StandaloneMode.ALLOW,
            ParameterMode.ARGUMENT,
            "Reason integer value: unused(0), keyCompromise(1),"
    ...
    if ((reason == 7) || (reason < 0) || (reason > 10)) {
      ...
      CertificateDataWrapper certWrapper =
          EjbRemoteHelper.INSTANCE
              ...
              .getCertificateDataByIssuerAndSerno(issuerDN, serno);
      if (certWrapper != null) {
        getLogger().info("Found certificate:");
        getLogger()
            .info(
                "Subject DN="
                    + certWrapper.getCertificateData().getSubjectDnNeverNull());
  ...
  public String getFullHelpText() {
    return getCommandDescription()
        + "\n"
        + "Unrevocation is done using the reason removeFromCRL(8), and can"
