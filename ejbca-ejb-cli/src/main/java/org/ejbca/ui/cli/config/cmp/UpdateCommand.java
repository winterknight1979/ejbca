...
/** @version $Id: UpdateCommand.java 28616 2018-04-03 11:51:50Z samuellb $ */
...
/** Logger. */
  ...
  public CommandResult execute(final ParameterContainer parameters) {
    ...
    LOG.info(
        "Configuration was: "
            + key
            + "="
            + getCmpConfiguration().getValue(key, alias));
  ...
  public String getFullHelpText() {
    ...
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_DEFAULTCA
            + " - possible values: "
            + existingCas
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_ALLOWRAVERIFYPOPO
            + " - possible values: true | false"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_OPERATIONMODE
            + " - possible values: client | ra"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_AUTHENTICATIONMODULE
            + " - possible values: RegTokenPwd | DnPartPwd | HMAC |"
            + " EndEntityCertificate | a combination of those methods"
            + " separated by ';'\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_AUTHENTICATIONPARAMETERS
            + " - possible values: See documentation in Admin Guid"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_EXTRACTUSERNAMECOMPONENT
            + " - possible values: DN | any SubjectDN attribut tex. CN, OU,"
            + " UID...etc\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_ALLOWCUSTOMCERTSERNO
            + " - possible values: true | false"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_NAMEGENERATIONSCHEME
            + " - possible values: DN | RANDOM | USERNAME | FIXED"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_NAMEGENERATIONPARAMS
            + " - possible values: See documentation in Admin Guid"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_NAMEGENERATIONPREFIX
            + " - possible values: ${RANDOM} | any alphanumeric string"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_NAMEGENERATIONPOSTFIX
            + " - possible values: ${RANDOM} | any alphanumeric string"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_PASSWORDGENPARAMS
            + " - possible values: random | any alphanumeric string"
            + "\n");
    ...
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RA_ENDENTITYPROFILEID
            + " - available IDs: "
            + existingEeps
            + "\n");
    ...
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RACANAME
            + " - possible values: ProfileDefault | "
            + existingCas
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RESPONSEPROTECTION
            + " - possible values: signature | pbe"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_VENDORCERTIFICATEMODE
            + " - possible values: true | false"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_VENDORCA
            + " - possible values: the name of the external CA. Several CAs"
            + " can be specified by separating them with ';'\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_RACERT_PATH
            + " - possible values: the path to the catalogue where the"
            + " certificate that will be used to authenticate"
            + " NestedMessageContent are stored.\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_ALLOWAUTOMATICKEYUPDATE
            + " - possible values: true | false"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_ALLOWUPDATEWITHSAMEKEY
            + " - possible values: true | false"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_ALLOWSERVERGENERATEDKEYS
            + " - possible values: true | false"
            + "\n");
    sb.append(
        "    "
            + CmpConfiguration.CONFIG_CERTREQHANDLER_CLASS
            + " - possible values: org.ejbca.core.protocol.unid.UnidFnrHandler"
