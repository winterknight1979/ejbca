 ...
 *
 * @version $Id: CaChangeCertProfileCommand.java 19968 2014-10-09 13:13:58Z
 *     mikekushner $
 */
public class CaChangeCertProfileCommand extends BaseCaAdminCommand {
  ...
  public String getFullHelpText() {
    ...
    Collection<Integer> cpssub =
        EjbRemoteHelper.INSTANCE
            .getRemoteSession(CertificateProfileSessionRemote.class)
            .getAuthorizedCertificateProfileIds(
                getAuthenticationToken(), CertificateConstants.CERTTYPE_SUBCA);
    Collection<Integer> cpsroot =
        EjbRemoteHelper.INSTANCE
            .getRemoteSession(CertificateProfileSessionRemote.class)
            .getAuthorizedCertificateProfileIds(
                getAuthenticationToken(), CertificateConstants.CERTTYPE_ROOTCA);
