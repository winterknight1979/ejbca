 ...
 *
 * @version $Id: CaEditCertificateProfileCommand.java 23457 2016-05-16 17:18:31Z
 *     mikekushner $
 */
public class CaEditCertificateProfileCommand extends BaseCaAdminCommand {
  ...
  public String getCommandDescription() {
    return "Edits profile fields of an existing certificate profile in the"
               + " CA. ";
  }
  ...
  public String getFullHelpText() {
    return getCommandDescription()
        + "Fields that can be set are derived from setFieldName of the"
        + " CertificateProfile java code. If there is a 'setFieldName(type)'"
        + " method, the values to use in this command should be 'fieldName"
        + " value'\n"
        + "Example: ca editcertificateprofile CertProfileName"
        + " CRLDistributionPointURI http://my-crl-distp.com/my.crl\n"
        + "Example: ca editcertificateprofile CertProfileName caIssuers"
        + " http://my-ca.issuer.com/ca\n"
        + "Example: ca editcertificateprofile CertProfileName useOcspNoCheck"
        + " true\n"
        + "Example: ca editcertificateprofile CertProfileName"
        + " numOfReqApprovals 1\n"
        + "\n"
        + "Use the option -listFields to only list available fields in the"
        + " certificate profile.\n"
        + "Example: ca editcertificateprofile CertProfileName -listFields\n"
        + "\n"
        + "Use the option -getValue to only get the value of a field in the"
        + " certificate profile.\n"
        + "Example: ca editcertificateprofile CertProfileName -getValue"
        + " caIssuers";
  }
