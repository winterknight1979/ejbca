 ...
 *
 * @version $Id: SetSubjectDNCommand.java 25012 2017-01-16 09:36:04Z mikekushner
 *     $
 */
public class SetSubjectDNCommand extends BaseRaCommand {
  ...
  public String getFullHelpText() {
    return getCommandDescription()
        + "\n\n"
        + "The SubjectDN fields are: emailAddress=<string>, UID=< unique"
        + " identifier>, CN=<common name>, serialNumber=<serialnumber>,"
        + " givenName=<string>, initials=<string>, surname=<string>,"
        + " title=<string>, OU=<the organizational unit>, O=<the"
        + " organization>, L=<locality>, ST=<state of province>, DC=<domain"
        + " component>, C=<two letter ISO3166>, unstructuredAddress=<IP"
        + " address>, unstructuredName=<domain name>, postalCode=<string>,"
        + " businessCategory=<organization type>, dnQualifier=<string>,"
        + " postalAddress=<the postal address>, telephoneNumber=<telephone"
        + " number>, pseudonym=<string>, streetAddress=<string>,"
        + " name=<string>, CIF=<tax ID code for companies in Spain>, NIF=<tax"
        + " ID number for companied in Spain>";
  }
