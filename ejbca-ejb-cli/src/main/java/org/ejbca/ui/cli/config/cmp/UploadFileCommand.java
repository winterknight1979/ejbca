  ...
  public String getFullHelpText() {
    ...
    sb.append(
        "Only one alias will be read. If one file contains configurations of"
            ...
            + " aliases read\n");
    sb.append(
        "Note that the alias 'cmp' is the default alias used when sending the"
            + " CMP request through the URL"
            + " 'http://HOST:PORT/ejbca/publicweb/cmp'. Note also that the"
            + " alias 'cmp' does not exist per default and should be created"
            + " before using this URL\n");
    sb.append(
