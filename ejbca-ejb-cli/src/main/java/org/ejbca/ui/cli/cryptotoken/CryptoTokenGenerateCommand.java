 ...
 *
 * @version $Id: CryptoTokenGenerateCommand.java 20288 2014-11-20 14:04:16Z
 *     anatom $
 */
public class CryptoTokenGenerateCommand extends BaseCryptoTokenCommand {
...

  {
    ...
    registerParameter(
        new Parameter(
            KEY_SPECIFICATION_KEY,
            "Key Specification",
            MandatoryMode.MANDATORY,
            StandaloneMode.ALLOW,
            ParameterMode.ARGUMENT,
            "Key specification, for example 2048, secp256r1, DSA1024,"
                + " gost3410, dstu4145"));
  }
  ...
  public CommandResult executeCommand(
    ...
    try {
      EjbRemoteHelper.INSTANCE
          ...
          .createKeyPair(
              getAdmin(), cryptoTokenId, keyPairAlias, keyPairSpecification);
