...

  {
    ...
    registerParameter(
        new Parameter(
            ...
            StandaloneMode.ALLOW,
            ParameterMode.ARGUMENT,
            "Status: NEW=10; FAILED=11; INITIALIZED=20; INPROCESS=30;"
                + " GENERATED=40; HISTORICAL=50"));
  }
  ...
  public CommandResult execute(final ParameterContainer parameters) {
    ...
    try {
      EjbRemoteHelper.INSTANCE
          ...
          .setUserStatus(getAuthenticationToken(), username, status);
      getLogger()
          .info("New status for end entity " + username + " is " + status);
