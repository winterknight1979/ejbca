 ...
 *
 * @version $Id: ListEndEntitiesCommand.java 27715 2018-01-02 16:55:19Z
 *     mikekushner $
 */
public class ListEndEntitiesCommand extends BaseRaCommand {
...

  {
    registerParameter(
        new Parameter(
            ...
            "Status: ANY=00; NEW=10; FAILED=11; INITIALIZED=20; INPROCESS=30;"
                + " GENERATED=40; REVOKED=50; HISTORICAL=60; KEYRECOVERY=70"));
  }
  ...
  public CommandResult execute(final ParameterContainer parameters) {
    ...
    if (status == 0) {
      ...
      coll =
          EjbRemoteHelper.INSTANCE
              .getRemoteSession(EndEntityAccessSessionRemote.class)
              .findAllUsersByStatus(getAuthenticationToken(), status);
    }
    if (coll.size() == 0) {
  ...
  public String getFullHelpText() {
    ...
    sb.append(
        "Outputs comma separated items: username, subjectDN, subjectAltName,"
            + " email, status, type, tokenType, hardTokenIssuerId.\n");
    return sb.toString();
  }
