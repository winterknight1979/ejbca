 ...
 *
 * @version $Id: CaEditPublisherCommand.java 23457 2016-05-16 17:18:31Z
 *     mikekushner $
 */
public class CaEditPublisherCommand extends BaseCaAdminCommand {
  ...
  public String getFullHelpText() {
    return getCommandDescription()
        ...
        + " publisher java code. If there is a 'setFieldName(type)' method,"
        + " the values to use in this command should be 'fieldName value'\n"
        + "Example: ca editpublisher PublisherName hostnames myhost.com\n"
        + "Example: ca editpublisher PublisherName addMultipleCertificates"
        + " true\n"
