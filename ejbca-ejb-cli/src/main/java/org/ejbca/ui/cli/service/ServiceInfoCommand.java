 ...
 *
 * @version $Id: ServiceInfoCommand.java 24491 2016-10-10 11:47:00Z anatom $
 */
public class ServiceInfoCommand extends BaseServiceCommand {
  ...
  private void info(final String name, final boolean value) {
    info(name, value ? "Yes" : "No");
  }

  private void info(final String name, final String[] value) {
    if (value == null) {
      info(name, "null");
      return;
    }
  ...
  private void showProperties(final Properties props) {
    if (props == null) {
