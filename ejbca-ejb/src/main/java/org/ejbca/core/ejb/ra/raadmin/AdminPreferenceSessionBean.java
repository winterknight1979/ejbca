 ...
 */
@Stateless(
    mappedName = JndiConstants.APP_JNDI_PREFIX + "AdminPreferenceSessionRemote")
...
public class AdminPreferenceSessionBean
  ...
  public AdminPreference getAdminPreference(
    ...
    if (certificatefingerprint != null) {
      AdminPreferencesData adminPreferencesData =
  ...
  @Override
  public boolean addAdminPreference(
      final X509CertificateAuthenticationToken admin,
    ...
    if (AdminPreferencesData.findById(entityManager, certificatefingerprint)
        == null) {
      try {
        ...
        details.put("msg", msg);
        auditSession.log(
            EjbcaEventTypes.RA_ADDADMINPREF,
            EventStatus.SUCCESS,
            EjbcaModuleTypes.RA,
  ...
  @Override
  public boolean changeAdminPreference(
      final X509CertificateAuthenticationToken admin,
      final AdminPreference adminpreference) {
  ...
  @Override
  public boolean changeAdminPreferenceNoLog(
      final X509CertificateAuthenticationToken admin,
      final AdminPreference adminpreference) {
  ...
  @Override
  public List<RaStyleInfo> getAvailableRaStyleInfos(
  ...
  public AdminPreference getDefaultAdminPreference() {
    ...
    AdminPreference ret = null;
    AdminPreferencesData apdata =
        AdminPreferencesData.findById(entityManager, DEFAULTUSERPREFERENCE);
    if (apdata != null) {
      ret = apdata.getAdminPreference();
    } else {
      try {
        // Create new configuration
        AdminPreferencesData newapdata =
            new AdminPreferencesData(
                DEFAULTUSERPREFERENCE, new AdminPreference());
  ...
  @Override
  public void saveDefaultAdminPreference(
      final AuthenticationToken admin,
    ...
    if (!authorizationSession.isAuthorized(
      ...
      details.put("msg", msg);
      auditSession.log(
          EjbcaEventTypes.RA_DEFAULTADMINPREF,
          EventStatus.FAILURE,
          EjbcaModuleTypes.RA,
          EjbcaServiceTypes.EJBCA,
          admin.toString(),
   ...
   * @return bool
   */
  private boolean updateAdminPreference(
      final X509CertificateAuthenticationToken admin,
      final AdminPreference adminpreference,
      final boolean dolog) {
    String certificatefingerprint =
    ...
    boolean ret = false;
    AdminPreferencesData apdata1 =
        AdminPreferencesData.findById(entityManager, certificatefingerprint);
    if (apdata1 != null) {
      final Map<Object, Object> diff =
          apdata1.getAdminPreference().diff(adminpreference);
      ...
      if (dolog) {
        ...
        auditSession.log(
            EjbcaEventTypes.RA_EDITADMINPREF,
            EventStatus.SUCCESS,
            EjbcaModuleTypes.RA,
            EjbcaServiceTypes.EJBCA,
            admin.toString(),
  ...
  public Integer getCurrentRaStyleId(final AuthenticationToken admin) {
    ...
    AdminPreference adminPreference =
        getAdminPreference(certificatefingerprint);
  ...
  @Override
  public void setCurrentRaStyleId(
      final int currentStyleId, final AuthenticationToken admin) {
    ...
    updateAdminPreference(
        (X509CertificateAuthenticationToken) admin, adminPreference, false);
  }
  ...
  @Override
  public void setCurrentRaLocale(
      final Locale locale, final AuthenticationToken admin) {
