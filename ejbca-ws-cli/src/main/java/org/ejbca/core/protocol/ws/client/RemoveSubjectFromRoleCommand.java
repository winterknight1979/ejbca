...
public class RemoveSubjectFromRoleCommand extends EJBCAWSRABaseCommand
   ...
   */
  public RemoveSubjectFromRoleCommand(final String[] args) {
    super(args);
  }
    ...
    try {
      ...
      getEjbcaRAWS()
          .removeSubjectFromRole(
              rolename, caname, matchwith, matchtype, matchvalue);
  ...
  protected void usage() {
    ...
    getPrintStream()
        .println("Command used to remove an administrator from a role");
    getPrintStream()
        .println(
            "Usage : removeadminfromrole <rolename> <caname> <matchwith>"
