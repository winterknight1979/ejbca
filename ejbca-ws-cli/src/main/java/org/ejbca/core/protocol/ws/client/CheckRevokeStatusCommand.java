 ...
 *
 * @version $Id: CheckRevokeStatusCommand.java 22924 2016-03-03 21:59:59Z
 *     samuellb $
 */
public class CheckRevokeStatusCommand extends EJBCAWSRABaseCommand
   ...
   */
  public CheckRevokeStatusCommand(final String[] args) {
    super(args);
  }
    ...
    try {
      ...
      try {
        ...
        if (status == null) {
          ...
          getPrintStream()
              .println("  CertificateSN : " + status.getCertificateSN());
          if (status.getReason() == RevokedCertInfo.NOT_REVOKED) {
            ...
            getPrintStream()
                .println(
                    "  Reason        : " + getRevokeReason(status.getReason()));
            getPrintStream()
                .println(
                    "  Date          : "
                        + status.getRevocationDate().toString());
          }
        }
