 ...
 *
 * @version $Id: EditUserCommand.java 24940 2016-12-21 09:43:55Z mikekushner $
 */
public class EditUserCommand extends EJBCAWSRABaseCommand
  ...
  protected void usage() {
    getPrintStream()
        .println(
            "Command used to add or edit userdata, if user exist will the data"
                + " be overwritten.");
    getPrintStream()
        .println(
            "Usage : edituser <username> <password|null> <clearpwd"
                ...
                + " <issueralias or NULL (optional)> <starttime or NULL"
                + " (optional)> <endtime (starttime)>\n\n");
    getPrintStream()
        .println(
    ...
    getPrintStream()
        .println(
            "Start time and end time is of form \"May 26, 2009 9:52 AM\" or"
                + " \"days:hours:minutes\"");
    getPrintStream().println();
