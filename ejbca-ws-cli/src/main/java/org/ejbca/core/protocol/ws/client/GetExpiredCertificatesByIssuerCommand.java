        ...
        List<Certificate> result =
            getEjbcaRAWS()
                .getCertificatesByExpirationTimeAndIssuer(
                    days, issuerDN, maxNumberOfResults);
    ...
    getPrintStream()
        .println(
            "Command used to find certificates that will expire within a"
                + " specified number of days and are issued by a specific CA");
    getPrintStream()
        .println(
            "Usage : getexpiredcertsbyissuer <numberOfDays> <issuerDN>"
