...
/**
 * THIS COMMAND DOES WORK FROM EXTERNAL RA, HOWEVER, IT IS CURRENTLY NOT
 * POSSIBLE TO SET A NEW PASSWORD AND FINALIZE THE ENROLLMENT THORUGH AN
 * EXTERNAL RA USING EJBCA-WS SINCE MOST WS OPERATIONS ARE ONLY SUPPORTED
 * LOCALLY (AGAINST THE CA).
 *
 * <p>TODO Could be useful to support keyRecoverNewest
 *
 * <p>Set status to key recovery for an end entity's certificate.
 *
 * @version $Id: KeyRecoverCommand.java 26316 2017-08-15 08:40:09Z henriks $
 */
public class KeyRecoverCommand extends EJBCAWSRABaseCommand
   ...
   */
  public KeyRecoverCommand(final String[] args) {
    super(args);
  }
  ...
  protected void usage() {
    ...
    getPrintStream()
        .println("Usage : keyrecover <username> <certSerialNr> <issuerDN>");
  }
}
