 ...
 *************************************************************************/
 ...
 // Version: $Id: keybinding.jsp 34360 2020-01-23 09:25:05Z samuellb $
%>
...
<div class="container">
	...
	<h:panelGrid columns="3">
		...
		<h:panelGroup id="certificateId" rendered="#{internalKeyBindingMBean.boundToCertificate}">
			<h:outputLink target="_blank" rel="noopener" value="adminweb/viewcertificate.jsp?certsernoparameter=#{internalKeyBindingMBean.boundCaCertificateSerialNumber},#{internalKeyBindingMBean.boundCaCertificateIssuerDn}&ref=keybindings">
			...
			<h:outputText value="  "/>
			<h:outputLink target="_blank" rel="noopener" value="adminweb/viewcertificate.jsp?certsernoparameter=#{internalKeyBindingMBean.boundCertificateSerialNumber},#{internalKeyBindingMBean.boundCertificateIssuerDn}&ref=keybindings">
