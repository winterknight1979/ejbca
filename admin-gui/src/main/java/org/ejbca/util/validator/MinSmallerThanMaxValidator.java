...
/**
 * Validator which will validate that a BigInteger value is smaller than another
 * input value.
 *
 * @version $Id: MinSmallerThanMaxValidator.java 27466 2017-12-07 14:26:31Z
 *     antonh $
 */
public class MinSmallerThanMaxValidator implements Validator {
  ...
  public void validate(
    ...
    final String maxInput =
        (String) component.getAttributes().get("maxFieldInput");
