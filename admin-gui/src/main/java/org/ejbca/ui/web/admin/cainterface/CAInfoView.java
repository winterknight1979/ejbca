...
public class CAInfoView implements Serializable, Cloneable {
  ...
  /**
   * A info text strings must contain: CANAME, CERT_SUBJECTDN,
   * EXT_ABBR_SUBJECTALTNAME, CATYPE, EXPIRES, STATUS, DESCRIPTION,
   * CRL_CA_CRLPERIOD, CRL_CA_ISSUEINTERVAL, CRL_CA_OVERLAPTIME,
  ...
  private void setupGeneralInfo(
    ...
    switch (cainfo.getStatus()) {
      ...
      case CAConstants.CA_REVOKED:
        cainfodata[STATUS] =
            ejbcawebbean.getText("CAREVOKED")
                + "<br>&nbsp;&nbsp;"
