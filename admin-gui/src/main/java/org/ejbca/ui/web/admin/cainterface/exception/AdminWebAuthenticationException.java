 ...
 * <p>
 * The message, but not the stacktrace, should be sent to the client.
 *
 * @version $Id: AdminWebAuthenticationException.java 34154 2019-12-23 13:38:17Z samuellb $
 */
public final class AdminWebAuthenticationException extends Exception {
     ...
     */
    public AdminWebAuthenticationException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
