...
/**
 * Class with utility methods to find all implementations of a given interface
 * using the ServiceLoader functionality of JRE 1.6.
 *
...
public final class CustomLoader {
   ...
   * java.util.ServiceLoader. The implementations class names must be added to
   * the text file META-INF/services/ in its JAR file, with one class name per
   * line.
   *
   ...
   */
  public static <T> List<String> getCustomClasses(
  ...
  /**
   * Checks whether a class was displayed in the list of classes in the user
   * interface.
   *
