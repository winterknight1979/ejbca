...
public abstract class BaseAdminServlet extends HttpServlet {
   ...
   */
  protected AuthenticationToken authenticateAdmin(
      final HttpServletRequest request,
      final HttpServletResponse response,
      final String... accessResources)
      throws AdminWebAuthenticationException, ServletException {
    // Check if authorized
    ...
    if (certs == null) {
      ...
      throw new AdminWebAuthenticationException(
  ...
  /**
   * Gets the RAInterfaceBean object, or creates and initializes a new
   * RAInterfaceBean if not already created.
   *
   * @param req Request
   * @return Bean
   * @throws ServletException Fail
   */
  protected final RAInterfaceBean getRaBean(final HttpServletRequest req)
        ...
        rabean =
            (RAInterfaceBean)
                Beans.instantiate(
                    ...
                    org.ejbca.ui.web.admin.rainterface.RAInterfaceBean.class
                        .getName());
  ...
  /**
   * Gets the EjbcaWebBean object, or creates and initializes a new EjbcaWebBean
   ...
   * @throws ServletException Fail
   */
  protected final EjbcaWebBean getEjbcaWebBean(final HttpServletRequest req)
      throws ServletException {
    HttpSession session = req.getSession();
    EjbcaWebBean ejbcawebbean =
        (EjbcaWebBean) session.getAttribute("ejbcawebbean");
    if (ejbcawebbean == null) {
      try {
        ...
        throw new ServletException(
            " Cannot create bean of class " + EjbcaWebBean.class.getName(),
            exc);
      }
