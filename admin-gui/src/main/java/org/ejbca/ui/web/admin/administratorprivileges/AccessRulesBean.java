...
/**
 * Managed Bean for the Role's access rules pages: - Basic mode access rule
 * configuration - Advanced mode access rule configuration - Advanced mode
 * access rule summary.
 *
...
public class AccessRulesBean extends BaseManagedBean implements Serializable {
  ...
  private static class AccessRule {
    ...
    AccessRule(final String aresource, final boolean astate) {
      this.resource = AccessRulesHelper.normalizeResource(aresource);
      this.state = astate;
    }
  }
  ...
  private static class AccessRulesTemplate {
     ...
     */
    AccessRulesTemplate(
        final String aname, final AccessRule... theaccessRules) {
      this.name = aname;
      for (final AccessRule accessRule : theaccessRules) {
  ...
  public static class AccessRuleCollection {
    ...
    private final String name;
    /** PAram. */
    private final List<AccessRuleItem> collection;
    ...
    public AccessRuleCollection(
        final String aname, final List<AccessRuleItem> acollection) {
      this.name = aname;
     ...
     * @return Items
     */
    public List<AccessRuleItem> getCollection() {
      return collection;
    }
  }

  /** Advanced mode access rule tri-state. */
  private enum AccessRuleState {
        /** Typr. */
    UNDEFINED,
    /** Typr. */
    ALLOW,
  ...
  public static class AccessRuleItem
      implements Comparable<AccessRuleItem>, Serializable {
     ...
     * @param acategory Cat
     * @param aresource Res
     * @param aresourceName Name
     */
    public AccessRuleItem(
        final String acategory,
        final String aresource,
        final String aresourceName) {
      this.category = acategory;
      this.resource = AccessRulesHelper.normalizeResource(aresource);
      this.resourceName =
          aresourceName == null
              ? this.resource
              : AccessRulesHelper.normalizeResource(aresourceName);
      ...
      if (resourceSplit.length == 0) {
        ...
        String aresourceMain = "/";
        for (int i = 1; i < resourceSplit.length - 1; i++) {
          aresourceMain += resourceSplit[i] + "/";
        }
        this.resourceMain = aresourceMain;
      }
    }
    ...
    /**
     * @return the first part(s) of the resourceName e.g. '/mainrule/subrule/'
     *     from '/mainrule/subrule/subsubrule/'
     */
    public String getResourceMain() {
      return resourceMain;
    }
    /**
     * @return the last part of the resourceName e.g. 'subsubrule/' from
     *     '/mainrule/subrule/subsubrule/'
     */
    public String getResourceSub() {
      return resourceSub;
    }
    /**
     * @return one of the {@link AccessRuleState} enum names representing the
    ...
    /**
     * Set one of the {@link AccessRuleState} enum names representing the
     * current state of this rule.
     *
     * @param astate state
     */
    public void setState(final String astate) {
      this.state = AccessRuleState.valueOf(astate);
    }
    /**
     * @return one of the {@link AccessRuleState} enum representing the current
     *     state of this rule
     */
    private AccessRuleState getStateEnum() {
      return state;
    }
    /** @return true if the resource in this istance is '/' */
    public boolean isRootResource() {
      return StandardRules.ROLE_ROOT.resource().equals(resource);
    }
  ...
  /** Param. */
  private static final List<AccessRulesTemplate> ACCESS_RULES_TEMPLS =
      Arrays.asList(
          new AccessRulesTemplate(
              "SUPERVISOR",
              new AccessRule(
                  AccessRulesConstants.ROLE_ADMINISTRATOR, Role.STATE_ALLOW),
          ...
          new AccessRulesTemplate(
              ...
              new AccessRule(
                  ...
                  Role.STATE_ALLOW),
              new AccessRule(
                  InternalKeyBindingRules.VIEW.resource(), Role.STATE_ALLOW),
              ...
              new AccessRule(
                  ...
                  Role.STATE_ALLOW),
              new AccessRule(
                  CryptoTokenRules.VIEW.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWPUBLISHER, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWVALIDATOR, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.SERVICES_VIEW, Role.STATE_ALLOW),
              new AccessRule(
              ...
              new AccessRule(
                  ...
                  Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.CUSTOMCERTEXTENSIONCONFIGURATION_VIEW
                      .resource(),
                  Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.VIEWROLES.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWENDENTITY, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWENDENTITYHISTORY,
                  Role.STATE_ALLOW)),
          new AccessRulesTemplate(
              ...
              new AccessRule(
                  ...
                  Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_EDITENDENTITY, Role.STATE_ALLOW),
              new AccessRule(
              ...
              new AccessRule(
                  ...
                  Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_KEYRECOVERY, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_APPROVEENDENTITY,
                  Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWPUKS, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWAPPROVALS, Role.STATE_ALLOW),
              new AccessRule(AuditLogRules.VIEW.resource(), Role.STATE_ALLOW)),
          new AccessRulesTemplate(
              "CAADMINISTRATOR",
              new AccessRule(
                  AccessRulesConstants.ROLE_ADMINISTRATOR, Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.CAFUNCTIONALITY.resource(), Role.STATE_ALLOW),
              new AccessRule(StandardRules.CAVIEW.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.CERTIFICATEPROFILEVIEW.resource(),
                  Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_EDITPUBLISHER, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWPUBLISHER, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_EDITVALIDATOR, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_VIEWVALIDATOR, Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.REGULAR_EDITBLACKLIST, Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.VALIDATORACCESSBASE.resource(),
                  Role.STATE_ALLOW),
              // This was present in legacy DefaultRoles, but makes very little
              // sense
              ...
              new AccessRule(
                  ...
                  Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.EDITROLES.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  StandardRules.VIEWROLES.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  AccessRulesConstants.ENDENTITYPROFILEBASE, Role.STATE_ALLOW),
              // new
              // AccessRule(AccessRulesConstants.REGULAR_VIEWENDENTITYPROFILES,
              // Role.STATE_ALLOW),
              new AccessRule(
          ...
          /*
           * Note:
           * We DO NOT allow CA Administrators to USE CryptoTokens,
           * since this would mean that they could
           ...
           */
              new AccessRule(
                  InternalKeyBindingRules.DELETE.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  InternalKeyBindingRules.MODIFY.resource(), Role.STATE_ALLOW),
              new AccessRule(
                  InternalKeyBindingRules.VIEW.resource(), Role.STATE_ALLOW),
              // From legacy JS
              new AccessRule(AuditLogRules.VIEW.resource(), Role.STATE_ALLOW)),
          new AccessRulesTemplate(
              "SUPERADMINISTRATOR",
              new AccessRule(
                  StandardRules.ROLE_ROOT.resource(), Role.STATE_ALLOW)),
          // Ignore the legacy "HARDTOKENISSUER" template since it is rarely
          // used
  ...
  /**
   * Perform POST-REDIRECT-GET when this method is invoked from a non-AJAX
   * context.
   */
  ...
  public boolean isAuthorizedToEditRole() {
    return authorizationSession.isAuthorizedNoLogging(
            getAdmin(), StandardRules.EDITROLES.resource())
        && getRole() != null;
  }

  /**
   * @return an authorized existing role based on the roleId HTTP param or null
   *     if no such role was found.
   */
  public Role getRole() {
  ...
  /**
   * Recalculate selection based on current state of template selection or
   * loaded role's access rules.
   */
  private void reinitSelection() {
    // Reset available lists that might be rendered differently depending on
    // selected template
    ...
    final LinkedHashMap<String, Boolean> accessRules =
        getRole().getAccessRules();
    // Find CA access resources allowed by this role
    setResourcesCaSelected(
        getSelectedRulesFromIdentifiers(
            accessRules,
            StandardRules.CAACCESS.resource(),
            caIdToNameMap.keySet()));
    // Find RA resources allowed by this role
    setResourcesEeSelected(
        getSelectedRulesFromSelectItems(
            accessRules, getAvailableResourcesEe()));
    // Find EEP resources allowed by this role
    setResourcesEepSelected(
        getSelectedRulesFromIdentifiers(
            accessRules,
            AccessRulesConstants.ENDENTITYPROFILEPREFIX,
            eepIdToNameMap.keySet(),
            getAvailableResourcesEe()));
    // Find KV resources allowed by this role
    setResourcesKeyValidatorsSelected(
        getSelectedRulesFromIdentifiers(
            accessRules,
            StandardRules.VALIDATORACCESS.resource(),
            keyValidatorsIdToNameMap.keySet()));
    // Find IKB resources allowed by this role
    setResourcesIkbSelected(
        getSelectedRulesFromSelectItems(
            accessRules, getAvailableResourcesIkb()));
    // Find Other resources allowed by this role
    setResourcesOtherSelected(
        getSelectedRulesFromSelectItems(
            accessRules, getAvailableResourcesOther()));
  }
   ...
   */
  private List<String> getSelectedRulesFromIdentifiers(
      final LinkedHashMap<String, Boolean> accessRules,
    ...
    if (AccessRulesHelper.hasAccessToResource(accessRules, baseResource)) {
      ...
      for (final int id : ids) {
        final String resource =
            AccessRulesHelper.normalizeResource(baseResource + id);
  ...
  /**
   * Like {@link #getSelectedRulesFromIdentifiers}, but also includes rules that
   * have all enabled sub-rules present. (example: if "Create End Entity" and
   * "Edit End Entity" are selected, then it will also include all profiles that
   * have those items allowed)
   *
   * @param accessRules Access Rules
   * @param baseResource Base Resource
   * @param ids IDs
  ...
  private List<String> getSelectedRulesFromIdentifiers(
    ...
    final List<String> ret =
        getSelectedRulesFromIdentifiers(accessRules, baseResource, ids);
    // Also add items where all allowed sub-rules are explicitly allowed for the
    // item
    for (final int id : ids) {
      final String resource =
          AccessRulesHelper.normalizeResource(baseResource + id);
      ...
      for (final SelectItem selectedSubRule : selectedSubRules) {
        final String subRule =
            String.valueOf(selectedSubRule.getValue())
                .replace(
                    AccessRulesConstants.REGULAR_RAFUNCTIONALITY + "/", "");
      ...
      if (allSubRulesAllowed) {
        if (LOG.isDebugEnabled()) {
          LOG.debug(
              "Item "
                  + resource
                  + " is considered to be allowed, since all allowed sub-rules"
                  + " are also allowed for this item");
        }
        ret.add(resource);
      }
    }
   ...
   * @return minimal list of resources that the provided access rules grants
   */
  private List<String> getSelectedRulesFromSelectItems(
      final LinkedHashMap<String, Boolean> accessRules,
    ...
    for (final SelectItem selectItem : selectItems) {
      ...
      if (AccessRulesHelper.hasAccessToResource(
          getRole().getAccessRules(), resource)) {
        ret.add(resource);
      }
    }
    return ret;
  ...
  public String getAccessRulesTemplateSelected() {
    return accessRulesTemplateSelected;
  }
  /**
   * Set the currently select role template.
   *
   * @param anaccessRulesTemplateSelected template
   */
  public void setAccessRulesTemplateSelected(
      final String anaccessRulesTemplateSelected) {
    this.accessRulesTemplateSelected = anaccessRulesTemplateSelected;
  }

  /**
   * @return true if this role is assumed to have been configured outside of the
   *     basic mode
   */
  public boolean isAccessRulesTemplateCustom() {
    return TEMPLATE_NAME_CUSTOM.equals(getAccessRulesTemplateSelected());
  }
  /**
   * @return true if this role is assumed to have been configured using the
   *     CAAdministrator template
   */
  private boolean isAccessRulesTemplateCaAdmin() {
    return "CAADMINISTRATOR".equals(getAccessRulesTemplateSelected());
  }
  /**
   * @return true if this role is assumed to have been configured using the
   *     SuperAdministrator template
   */
  private boolean isAccessRulesTemplateSuperAdmin() {
    return "SUPERADMINISTRATOR".equals(getAccessRulesTemplateSelected());
  }
  /**
   * @return true if this role is assumed to have been configured using
   *     RaAdministrator template
   */
  private boolean isAccessRulesTemplateRaAdmin() {
    return "RAADMINISTRATOR".equals(getAccessRulesTemplateSelected());
  }

  /** @return currently selected AccessRuleTemplate */
  private AccessRulesTemplate getAccessRulesTemplate() {
    for (final AccessRulesTemplate accessRulesTemplate : ACCESS_RULES_TEMPLS) {
      if (accessRulesTemplate
          .getName()
          .equals(getAccessRulesTemplateSelected())) {
  ...
  /**
   * Invoked by the user when changing selected template and JavaScript is
   * enabled.
   *
   * @param event Event
   */
  public void actionAccessRulesTemplateSelectAjaxListener(
      final AjaxBehaviorEvent event) {
    actionAccessRulesTemplateSelect();
  }

  /**
   * Invoked by the user when changing selected template and JavaScript is
   * disabled (or via the AJAX call).
   */
  public void actionAccessRulesTemplateSelect() {
    ...
    if (!isAccessRulesTemplateCustom()) {
      // Remove the CUSTOM template from the list of selectable templates since
      // it is really configured in advanced mode
      removeAccessRulesTemplateCustomOption();
    }
  }

  /**
   * @return a list of available access rules templates (and detects the best
   *     match to the existing role's rules for performance reasons at the same
   *     time)
   */
  public List<SelectItem> getAvailableAccessRulesTemplates() {
    if (availableAccessRulesTemplates == null) {
      ...
      for (final AccessRulesTemplate accessRulesTemplate
          : ACCESS_RULES_TEMPLS) {
        // Ensure that current admin is authorized to all access rules implied
        // by the template
        final List<String> allowedResources = new ArrayList<>();
        // Ensure that there is no access rule in role that is not covered by
        // template to check for a match
        if (getRole() != null) {
          if (getRole().getAccessRules() != null) {
            final HashMap<String, Boolean> remainingAccessRulesInRole =
                new HashMap<>(getRole().getAccessRules());
            ...
            filterOutSelectItems(
                remainingAccessRulesInRole, getAvailableResourcesCa());
            filterOutSelectItems(
                remainingAccessRulesInRole, getAvailableResourcesEep());
            filterOutSelectItems(
                remainingAccessRulesInRole,
                getAvailableResourcesKeyValidators());
            for (final Entry<String, Boolean> entry
               : accessRulesTemplate.getAccessRules().entrySet()) {
              if (entry.getValue().booleanValue()) {
                final String resource = entry.getKey();
                allowedResources.add(resource);
                remainingAccessRulesInRole.remove(
                    AccessRulesHelper.normalizeResource(resource));
              }
            }
            if (authorizationSession.isAuthorizedNoLogging(
                getAdmin(), allowedResources.toArray(new String[0]))) {
              availableAccessRulesTemplates.add(
                  new SelectItem(
                      accessRulesTemplate.getName(),
                      super.getEjbcaWebBean()
                          .getText(accessRulesTemplate.getName())));
              ...
              if (remainingAccessRulesInRole.isEmpty()) {
                ...
                if (LOG.isDebugEnabled()) {
                  LOG.debug(
                      "Role '"
                          + getRole().getRoleNameFull()
                          + "' does not qualify as a '"
                          + accessRulesTemplate.getName()
                          + "'. Extra rules: "
                          + Arrays.toString(
                              remainingAccessRulesInRole.keySet().toArray()));
                }
              }
            }
          } else {
            if (LOG.isDebugEnabled()) {
              LOG.debug(
                  "Role with name "
                      + role.getRoleName()
                      + " returned a null access rule list.");
            }
          }
        } else {
          if (LOG.isDebugEnabled()) {
  ...
  private void removeAccessRulesTemplateCustomOption() {
    for (final SelectItem selectItem
        : new ArrayList<>(availableAccessRulesTemplates)) {
  ...
  public List<String> getResourcesCaSelected() {
    return resourcesCaSelected;
  }
  /**
   * Set the currently selected CA access resources.
   *
   * @param aresourcesCaSelected Sccess resources
   */
  public void setResourcesCaSelected(final List<String> aresourcesCaSelected) {
    this.resourcesCaSelected = new ArrayList<>(aresourcesCaSelected);
  }
  ...
  public List<SelectItem> getAvailableResourcesCa() {
    if (availableResourcesCa == null) {
      ...
      for (final int caId : caSession.getAuthorizedCaIds(getAdmin())) {
        final String name =
            caIdToNameMap.containsKey(caId)
                ? caIdToNameMap.get(caId)
                : String.valueOf(caId);
        availableResourcesCa.add(
            new SelectItem(
                AccessRulesHelper.normalizeResource(
      ...
      if (authorizationSession.isAuthorizedNoLogging(
          getAdmin(), StandardRules.CAACCESS.resource())) {
        availableResourcesCa.addFirst(
            new SelectItem(
                StandardRules.CAACCESS.resource(),
                super.getEjbcaWebBean().getText("ALL")));
      }
    }
  ...
  public boolean isRenderResourcesEeSelection() {
    return !isAccessRulesTemplateCustom()
        && !isAccessRulesTemplateSuperAdmin()
        && !isAccessRulesTemplateCaAdmin();
  }

  /** @return the currently selected RA functionality resources */
  public List<String> getResourcesEeSelected() {
    return resourcesEeSelected;
  }
  /**
   * Set the currently selected RA functionality resources.
   *
   * @param aresourcesEeSelected EE Selection
   */
  public void setResourcesEeSelected(final List<String> aresourcesEeSelected) {
    this.resourcesEeSelected = new ArrayList<>(aresourcesEeSelected);
  }
  ...
  public List<SelectItem> getAvailableResourcesEe() {
    if (availableResourcesEe == null) {
      availableResourcesEe =
          new ArrayList<>(
          Arrays.asList(
              // Not part of basic mode
              // new
              // SelectItem(AccessRulesConstants.REGULAR_EDITENDENTITYPROFILES,
                  // super.getEjbcaWebBean().getText("EDITENDENTITYPROFILES")),
              // new
              // SelectItem(AccessRulesConstants.REGULAR_VIEWENDENTITYPROFILES,
                  // super.getEjbcaWebBean().getText("VIEWENDENTITYPROFILES")),
              // new
              // SelectItem(AccessRulesConstants.REGULAR_EDITUSERDATASOURCES,
                  // super.getEjbcaWebBean().getText("EDITUSERDATASOURCES")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_APPROVEENDENTITY),
                      super.getEjbcaWebBean().getText("APPROVEENDENTITYRULE")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_REVOKEENDENTITY),
                      super.getEjbcaWebBean().getText("REVOKEENDENTITYRULE")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_VIEWENDENTITY),
                      super.getEjbcaWebBean().getText("VIEWENDENTITYRULE")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_CREATEENDENTITY),
                      super.getEjbcaWebBean().getText("CREATEENDENTITYRULE")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_EDITENDENTITY),
                      super.getEjbcaWebBean().getText("EDITENDENTITYRULE")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_DELETEENDENTITY),
                      super.getEjbcaWebBean().getText("DELETEENDENTITYRULE")),
                  new SelectItem(
                      AccessRulesHelper.normalizeResource(
                          AccessRulesConstants.REGULAR_VIEWENDENTITYHISTORY),
                      super.getEjbcaWebBean().getText("VIEWHISTORYRULE"))));
      if (isEnabledIssueHardwareTokens()) {
        availableResourcesEe.add(
            new SelectItem(
                AccessRulesHelper.normalizeResource(
                    AccessRulesConstants.REGULAR_VIEWHARDTOKENS),
                super.getEjbcaWebBean().getText("VIEWHARDTOKENRULE")));
        availableResourcesEe.add(
            new SelectItem(
                AccessRulesHelper.normalizeResource(
                    AccessRulesConstants.REGULAR_VIEWPUKS),
                super.getEjbcaWebBean().getText("VIEWPUKENDENTITYRULE")));
      }
  ...
  /**
   * @return true if the End Entity Profile rule selection box should be
   *     modifiable
   */
  ...
  public List<String> getResourcesEepSelected() {
    return resourcesEepSelected;
  }
  /**
   * Set the currently selected EEP resources.
   *
   * @param aresourcesEepSelected EEP resources
   */
  public void setResourcesEepSelected(
          final List<String> aresourcesEepSelected) {
    this.resourcesEepSelected = new ArrayList<>(aresourcesEepSelected);
  }
  ...
  public List<SelectItem> getAvailableResourcesEep() {
    if (availableResourcesEep == null) {
      ...
      for (final int aneepId
          : endEntityProfileSession.getAuthorizedEndEntityProfileIds(
              getAdmin(), AccessRulesConstants.REGULAR_VIEWENDENTITY)) {
        final String name =
            eepIdToNameMap.containsKey(aneepId)
                ? eepIdToNameMap.get(aneepId)
                : String.valueOf(aneepId);
        availableResourcesEep.add(
            new SelectItem(
                AccessRulesHelper.normalizeResource(
                    AccessRulesConstants.ENDENTITYPROFILEPREFIX + aneepId),
                name));
      }
      super.sortSelectItemsByLabel(availableResourcesEep);
      if (authorizationSession.isAuthorizedNoLogging(
          getAdmin(), AccessRulesConstants.ENDENTITYPROFILEPREFIX)) {
        availableResourcesEep.addFirst(
            new SelectItem(
                AccessRulesConstants.ENDENTITYPROFILEPREFIX,
                super.getEjbcaWebBean().getText("ALL")));
      }
  ...
  public boolean isRenderResourcesKvSelection() {
    return !isAccessRulesTemplateCustom()
        && !isAccessRulesTemplateSuperAdmin()
        && !isAccessRulesTemplateRaAdmin();
  }

  /** @return the currently selected key validator resources */
  public List<String> getResourcesKeyValidatorsSelected() {
    return resourcesKeyValidatorsSelected;
  }

  /**
   * Set the currently selected key validator resources.
   *
   * @param aresourcesKeyValidatorsSelected Validators
   */
  public void setResourcesKeyValidatorsSelected(
      final List<String> aresourcesKeyValidatorsSelected) {
    this.resourcesKeyValidatorsSelected =
        new ArrayList<>(aresourcesKeyValidatorsSelected);
  }
  ...
  public List<SelectItem> getAvailableResourcesKeyValidators() {
    if (availableResourcesKeyValidators == null) {
      ...
      final Collection<Integer> authorizedKvIds =
          keyValidatorSession.getAuthorizedKeyValidatorIds(
              getAdmin(), AccessRulesConstants.REGULAR_VIEWVALIDATOR);
      if (LOG.isDebugEnabled()) {
        LOG.debug(
            "Authorized key validator ids for "
                + getAdmin().getUniqueId()
                + " are "
                + authorizedKvIds);
      }
      for (final int id : authorizedKvIds) {
        availableResourcesKeyValidators.add(
            new SelectItem(
                AccessRulesHelper.normalizeResource(
                    StandardRules.VALIDATORACCESS.resource() + id),
                keyValidatorsIdToNameMap.get(id)));
      }
      super.sortSelectItemsByLabel(availableResourcesKeyValidators);
      if (authorizationSession.isAuthorizedNoLogging(
          getAdmin(), StandardRules.VALIDATORACCESS.resource())) {
        availableResourcesKeyValidators.addFirst(
            new SelectItem(
                StandardRules.VALIDATORACCESS.resource(),
                super.getEjbcaWebBean().getText("ALL")));
      }
  ...
  /**
   * @return true if the InternalKeyBinding rule selection box should be
   *     modifiable
   */
  ...
  public List<String> getResourcesIkbSelected() {
    return resourcesIkbSelected;
  }
  /**
   * Set the currently selected IKB resources.
   *
   * @param aresourcesIkbSelected IKB Resources
   */
  public void setResourcesIkbSelected(
          final List<String> aresourcesIkbSelected) {
    this.resourcesIkbSelected = new ArrayList<>(aresourcesIkbSelected);
  }

  /** @return the selectable IKB resources */
  public List<SelectItem> getAvailableResourcesIkb() {
    if (availableResourcesIkb == null) {
      availableResourcesIkb =
          Arrays.asList(
              new SelectItem(
                  AccessRulesHelper.normalizeResource(
                      InternalKeyBindingRules.DELETE.resource()),
                  super.getEjbcaWebBean()
                      .getText(InternalKeyBindingRules.DELETE.getReference())),
              new SelectItem(
                  AccessRulesHelper.normalizeResource(
                      InternalKeyBindingRules.MODIFY.resource()),
                  super.getEjbcaWebBean()
                      .getText(InternalKeyBindingRules.MODIFY.getReference())),
              new SelectItem(
                  AccessRulesHelper.normalizeResource(
                      InternalKeyBindingRules.VIEW.resource()),
                  super.getEjbcaWebBean()
                      .getText(InternalKeyBindingRules.VIEW.getReference())));
  ...
  public List<String> getResourcesOtherSelected() {
    return resourcesOtherSelected;
  }
  /**
   * Set the currently selected Other resources.
   *
   * @param aresourcesOtherSelected Other resources
   */
  public void setResourcesOtherSelected(
      final List<String> aresourcesOtherSelected) {
    this.resourcesOtherSelected = new ArrayList<>(aresourcesOtherSelected);
  }
  ...
  public List<SelectItem> getAvailableResourcesOther() {
    if (availableResourcesOther == null) {
      ...
      availableResourcesOther.add(
          new SelectItem(
              AccessRulesHelper.normalizeResource(
                  AuditLogRules.VIEW.resource()),
              super.getEjbcaWebBean().getText("VIEWAUDITLOG")));
      if (isEnabledIssueHardwareTokens()) {
        availableResourcesOther.add(
            new SelectItem(
                AccessRulesHelper.normalizeResource(
                    AccessRulesConstants.HARDTOKEN_ISSUEHARDTOKENS),
                super.getEjbcaWebBean().getText("ISSUEHARDTOKENS")));
      }
  ...
  /**
   * @return true if this installation is configured to use
   *     EndEntityProfileLimitations
   */
  private boolean isEnableEndEntityProfileLimitations() {
    return super.getEjbcaWebBean()
  ...
  public void actionSaveAccessRules() {
    ...
    final HashMap<String, Boolean> newAccessRules =
        new HashMap<>(getAccessRulesTemplate().getAccessRules());
    ...
    if (isEnableEndEntityProfileLimitations()) {
      /*
       * To be authorized to an EEP, the authentication token needs
       *  to be authorized to both
       *  '/ra_functionality/some_function/'
       *  '/endentityprofilesrules/<eepId>/some_function/'
       *
       * So here in basic mode, we simply allow
       * '/endentityprofilesrules/<eepId>/' and rely
    ...
    final Role arole = getRole();
    arole.getAccessRules().clear();
    arole.getAccessRules().putAll(newAccessRules);
    try {
      this.role = roleSession.persistRole(getAdmin(), arole);
      super.addGlobalMessage(
          FacesMessage.SEVERITY_INFO, "ACCESSRULES_INFO_SAVED");
    } catch (RoleExistsException e) {
      throw new IllegalStateException(e);
    } catch (AuthorizationDeniedException e) {
      super.addGlobalMessage(
          FacesMessage.SEVERITY_ERROR,
          "ACCESSRULES_ERROR_UNAUTH",
          e.getMessage());
    } finally {
  ...
  /**
   * Remove the resources of the SelectItem values from the access rule map if
   * present.
   *
   * @param newAccessRules Rules
   * @param selectItems Items
   */
  private void filterOutSelectItems(
      final HashMap<String, Boolean> newAccessRules,
      final List<SelectItem> selectItems) {
    for (final SelectItem selectItem : selectItems) {
      final String selectedResource = String.valueOf(selectItem.getValue());
      final Iterator<Map.Entry<String, Boolean>> iter =
          newAccessRules.entrySet().iterator();
      while (iter.hasNext()) {
        ...
        if (allowed
            && (rule.equals(selectedResource)
                || rule.startsWith(selectedResource))) {
          iter.remove();
        }
      }
    }
  ...
  /**
   * @return a normalized, minimized and sorted list of access rules that is set
   *     to ALLOW or DENY
   */
  ...
  public List<AccessRuleCollection> getAuthorizedResourcesByCategory() {
    final Map<String, AccessRuleCollection> categoryToAccessRuleCollectionMap =
        new LinkedHashMap<>();
    for (final AccessRuleItem accessRuleItem : getAuthorizedAccessRuleItems()) {
      final String category = accessRuleItem.getCategory();
      AccessRuleCollection accessRuleCollection =
          categoryToAccessRuleCollectionMap.get(category);
      if (accessRuleCollection == null) {
        accessRuleCollection =
            new AccessRuleCollection(category, new ArrayList<AccessRuleItem>());
        categoryToAccessRuleCollectionMap.put(category, accessRuleCollection);
      }
      accessRuleCollection.getCollection().add(accessRuleItem);
    }
    for (final AccessRuleCollection accessRuleCollection
        : categoryToAccessRuleCollectionMap.values()) {
  ...
  private List<AccessRuleItem> getAuthorizedAccessRuleItems() {
    if (authorizedAccessRuleItems == null) {
      ...
      final LinkedHashMap<String, Boolean> rolesAccesssRules =
          getRole().getAccessRules();
      AccessRulesHelper.minimizeAccessRules(rolesAccesssRules);
      for (final AccessRuleItem accessRuleItem
          : new ArrayList<>(allAccessRuleItems)) {
        if (authorizationSession.isAuthorizedNoLogging(
            getAdmin(), accessRuleItem.getResource())) {
          // Check current Role' state of this rule
          accessRuleItem.setState(
              AccessRuleState.toAccessRuleState(
                      rolesAccesssRules.get(accessRuleItem.getResource()))
                  .name());
        } else {
          // Note that for EEPs you are only "really" authorized to it if you
          // also are authorized to all the CAs in it
          // Similar goes for UserDataSources which is super-inefficient to
          // check..
          // BUT if the current admin is authorized to a rule he is also
          // authorized to give the same access to others
  ...
  private List<AccessRuleItem> getAllAccessRuleItems() {
    ...
    final Map<String, Map<String, String>> categorizedAccessRules =
        authorizationSystemSession.getAllResourceAndResourceNamesByCategory();
    for (final Entry<String, Map<String, String>> categoryEntry
        : categorizedAccessRules.entrySet()) {
      for (final Entry<String, String> entry
          : categoryEntry.getValue().entrySet()) {
        allAccessRuleItem.add(
            new AccessRuleItem(
                categoryEntry.getKey(), entry.getKey(), entry.getValue()));
      }
    }
  ...
  public List<SelectItem> getAvailableAccessRuleStates() {
    if (availableAccessRuleStates.isEmpty()) {
      availableAccessRuleStates.add(
          new SelectItem(
              AccessRuleState.ALLOW.name(),
              super.getEjbcaWebBean()
                  .getText(
                      "ACCESSRULES_STATE_" + AccessRuleState.ALLOW.name())));
      availableAccessRuleStates.add(
          new SelectItem(
              AccessRuleState.DENY.name(),
              super.getEjbcaWebBean()
                  .getText(
                      "ACCESSRULES_STATE_" + AccessRuleState.DENY.name())));
      availableAccessRuleStates.add(
          new SelectItem(
              AccessRuleState.UNDEFINED.name(),
              super.getEjbcaWebBean()
                  .getText(
                      "ACCESSRULES_STATE_"
                          + AccessRuleState.UNDEFINED.name())));
  ...
  public List<SelectItem> getAvailableAccessRuleStatesRoot() {
    ...
    result.add(
        new SelectItem(
            AccessRuleState.ALLOW.name(),
            getEjbcaWebBean()
                .getText("ACCESSRULES_STATE_" + AccessRuleState.ALLOW.name())));
    result.add(
        new SelectItem(
            AccessRuleState.DENY.name(),
            getEjbcaWebBean()
                .getText("ACCESSRULES_STATE_" + AccessRuleState.DENY.name()),
            null,
            true));
    result.add(
        new SelectItem(
  ...
  public void actionSaveAccessRulesAdvanced() {
    final Role arole = getRole();
    final LinkedHashMap<String, Boolean> accessRules = arole.getAccessRules();
    accessRules.clear();
    for (final AccessRuleItem accessRuleItem : authorizedAccessRuleItems) {
      if (!AccessRuleState.UNDEFINED.equals(accessRuleItem.getStateEnum())) {
        accessRules.put(
            accessRuleItem.getResource(),
            AccessRuleState.ALLOW.equals(accessRuleItem.getStateEnum()));
      }
    }
    final int numberOfRulesBeforeSave = accessRules.size();
    try {
      this.role = roleSession.persistRole(getAdmin(), arole);
      final int numberOfRedundantRules =
          numberOfRulesBeforeSave - arole.getAccessRules().size();
      if (numberOfRedundantRules == 0) {
        ...
        super.addGlobalMessage(
            ...
            "ACCESSRULES_INFO_SAVED_MIN",
            numberOfRedundantRules);
      }
    } catch (RoleExistsException e) {
      throw new IllegalStateException(e);
    } catch (AuthorizationDeniedException e) {
