...
/** @version $Id: ServiceSession.java 24490 2016-10-10 11:32:07Z anatom $ */
public interface ServiceSession {
   ...
   * @throws ServiceExistsException if service already exists.
   */
  void cloneService(AuthenticationToken admin, String oldname, String newname)
      throws ServiceExistsException;
   ...
   * @throws ServiceExistsException if service already exists.
   */
  void renameService(AuthenticationToken admin, String oldname, String newname)
      throws ServiceExistsException;
   ...
   * @return a list of ServiceData objects using the given ID, or an empty list
   *     if nothing is found
   */
