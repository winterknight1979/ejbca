...
/**
 * @version $Id: CertificateRequestSession.java 25833 2017-05-10 16:19:27Z
 *     samuellb $
 */
public interface CertificateRequestSession {

  /**
   * Edits or adds a user and generates a certificate for that user in a single
   * transaction.
   *
   * @param admin is the requesting administrator
   * @param userdata contains information about the user that is about to get a
   *     certificate
   * @param req is the certificate request, base64 encoded binary request, in
  ...
  public byte[] processCertReq(
      ...
      throws CADoesntExistsException, AuthorizationDeniedException,
          NotFoundException, InvalidKeyException, NoSuchAlgorithmException,
  ...
  /**
   * Edits or adds a user and generates a certificate for that user in a single
   * transaction. Username and password in userdata and req message must match.
   *
   * @param admin is the requesting administrator
   * @param userdata contains information about the user that is about to get a
   *     certificate
   * @param req is the certificate request
   * @param responseClass the class of the response message that should be
   *     returned back
