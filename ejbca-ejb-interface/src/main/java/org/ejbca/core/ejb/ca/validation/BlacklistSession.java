 ...
 *
 * @version $Id: BlacklistSession.java 26315 2017-08-15 08:16:04Z anatom $
 */
public interface BlacklistSession {
   ...
   *     ca_functionality/edit_blacklist
   ...
   * @throws AuthorizationDeniedException required access rights are
   *     ca_functionality/edit_blacklist
   * @throws BlacklistDoesntExistsException if the public key blacklist does not
   *     exist.
   */
  void removeBlacklistEntry(
      AuthenticationToken admin, String type, String value)
   ...
   * @throws BlacklistDoesntExistsException if there's no public key blacklist
   ...
   *
   * @param type type
   * @param value fingerprint of the public key blacklist entry,
   *     BlacklistEntry.createFingerprint
   * @return a BlacklistEntry or null if a public key blacklist entry with the
   *     given fingerprint does not exist. Uses cache to get the object as
   *     quickly as possible.
   */
