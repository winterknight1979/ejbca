...
/**
 * @version $Id: OcspKeyRenewalSessionLocal.java 19902 2014-09-30 14:32:24Z
 *     anatom $
 */
@Local
public interface OcspKeyRenewalSessionLocal {
    ...
    /** Param. */
  String RENEW_ALL_KEYS = "all";

  /**
   * This method causes the standalone OCSP responder to renew its keystores.
   *
   * <p>This method will use the password stored in configuration, and is mainly
   * used for automatic key renewal. Will throw an exception if passwords can't
   * be set in memory.
   *
   * @param signerSubjectDN subject DN of the signing key to be renewed. The
   *     string OcspKeyRenewalSessionLocal.RENEW_ALL_KEYS will result
  ...
  /**
   * Cancels all running timers and starts the initial timer. This method should
   * be called from a servlet and be used to start the rekeying timer at
   * startup.
   */
  void startTimer();
}
