...
public class CAConstantsWS {
   ...
   * '2.5.29.32.0 http://foo.bar.com/mycps.txt'. You can add multiple policies
   * such as '2.5.29.32.0 http://foo.bar.com/mycps.txt 1.1.1.1.1
  ...
  /**
   * Certificate Revocation List (CRL) signing key alias. Must be the same as
   * the certificate signing key.
   */
  public static final String CAKEYPURPOSE_CRLSIGN_STRING =
      CATokenConstants.CAKEYPURPOSE_CRLSIGN_STRING;
  /** Used for decryption of key recovery data. Must be an RSA key. */
  public static final String CAKEYPURPOSE_KEYENCRYPT_STRING =
      CATokenConstants.CAKEYPURPOSE_KEYENCRYPT_STRING;
  /** Test signing key. Used by health-check. */
  public static final String CAKEYPURPOSE_TESTKEY_STRING =
      CATokenConstants.CAKEYPURPOSE_TESTKEY_STRING;
  /**
   * Default key. If any of the other aliases are not specified, this will be
   * used in their place. Must be an RSA key if decryption key aliases are not
   * specified.
   */
  public static final String CAKEYPURPOSE_DEFAULT_STRING =
