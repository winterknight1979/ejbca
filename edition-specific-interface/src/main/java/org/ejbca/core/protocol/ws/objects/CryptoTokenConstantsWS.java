...
public final class CryptoTokenConstantsWS {
  ...
  // org.cesecore.keys.token.CryptoToken.ALLOW_NONEXISTING_SLOT_PROPERTY;

  // -------------------
  // PKCS11 Crypto Token
  // -------------------
  /** Specific to PKCS#11. The slot label value */
  public static final String SLOT_LABEL_VALUE =
      org.cesecore.keys.token.PKCS11CryptoToken.SLOT_LABEL_VALUE;
  /** Specific to PKCS#11. The slot label type */
  public static final String SLOT_LABEL_TYPE =
      org.cesecore.keys.token.PKCS11CryptoToken.SLOT_LABEL_TYPE;
  /** Specific to PKCS#11. The path to the shared PKCS11 library */
  public static final String SHLIB_LABEL_KEY =
      org.cesecore.keys.token.PKCS11CryptoToken.SHLIB_LABEL_KEY;
  /** Specific to PKCS#11. The attributes label */
  public static final String ATTRIB_LABEL_KEY =
      org.cesecore.keys.token.PKCS11CryptoToken.ATTRIB_LABEL_KEY;
  /**
