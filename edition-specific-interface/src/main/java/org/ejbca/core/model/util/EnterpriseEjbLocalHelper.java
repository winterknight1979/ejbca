 ...
 *
 * @version $Id: EnterpriseEjbLocalHelper.java 23165 2016-04-11 16:49:18Z
 *     samuellb $
 */
  ...
  private EnterpriseEditionEjbBridgeSessionLocal
      ...
      if (!useEjb31GlobalJndiName) {
        ret =
            (EnterpriseEditionEjbBridgeSessionLocal)
                getInitialContext()
                    .lookup("java:comp/env/EnterpriseEditionEjbBridgeSession");
      }
    ...
    try {
      ...
      throw new LocalLookupException(
          "Cannot lookup EnterpriseEditionEjbBridgeSessionLocal.", e);
    }
    return ret;
  }
          ...
          getInitialContext()
              .lookup(
                  "java:global/ejbca/"
                      ...
                      + "!"
                      + localInterfaceClass.getName());
    } catch (NamingException e) {
      return getEnterpriseEditionEjbLocal()
          .getEnterpriseEditionEjbLocal(localInterfaceClass, null);
    }
  }
