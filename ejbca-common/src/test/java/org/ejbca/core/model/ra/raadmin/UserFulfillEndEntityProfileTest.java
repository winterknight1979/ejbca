    ...
    int currentSubTest = 1;
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            "username",
            "password",
            "CN=John Smith,OU=DEP1_1,OU=DEP2_3,C=SE",
            "null",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            "username",
            "password",
            "CN=John Smith,OU=DEP1_1,OU=DEP2_2",
            "null",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            "username",
            "password",
            "CN=John Smith,OU=DEP1_1,OU=DEP2_2, C=NO",
            "null",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "RFC822NAME=test@test.com, dnsname=test.primekey.se,"
                + " Upn=test@primekey.se, ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "dnsname=test.primekey.se, Upn=test@primekey.se,"
                + " ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "rfc822name=test@test.com, rfc822name=test@primekey.se,"
                + " dnsname=test.primekey.se, Upn=test@primekey.se,"
                + " ipaddress=11.11.1.2",
            "",
            "test@test.com",
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            STANDARD_DN,
            "rfc822name=test@test.com, dnsname=test.primekey.se,"
                + " Upn=test12@primekey.se, ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
        ...
        fail(
            "Not only domains of RFC822NAME and UPN where checked: "
                + e.getMessage());
      }
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "rfc822name=test@test.com, dnsname=test2.primekey.se,"
                + " Upn=test12@primekey.se, ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            STANDARD_DN,
            "rfc822name=test@test.com, dnsname=test.primekey.se,"
                + " Upn=test12@primekey.se, ipaddress=11.11.1.1",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "rfc822name=test11@test1.com, dnsname=test.primekey.se,"
                + " Upn=test12@primekey.se,ipaddress=11.11.1.1",
            "",
            "test11@test1.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      profile.setValue(
          EndEntityProfile.AVAILCERTPROFILES,
          0,
          CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER
              + ";"
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "rfc822name=test11@test.com, dnsname=test.primekey.se,"
                + " Upn=test12@primekey.se,ipaddress=11.11.1.1",
            "",
            "test11@test.com",
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "rfc822name=test@test.com, rfc822name=test@somefoo.com,"
                + " dnsname=test.primekey.se, Upn=test12@primekey.se,"
                + " ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "rfc822name=test@nodomain.com, rfc822name=test@anything.com,"
                + " rfc822name=test@somefoo.com, dnsname=test.primekey.se,"
                + " Upn=test12@primekey.se, ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "password",
            STANDARD_DN,
            "rfc822name=test@test.com, rfc822name=test@anything.com,"
                + " rfc822name=test@somebar.com, dnsname=test.primekey.se,"
                + " Upn=test12@primekey.se, ipaddress=11.11.1.2",
            "",
            "test@test.com",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            STANDARD_DN,
            "rfc822name=test@test.com, rfc822name=test@anything.com,"
                + " rfc822name=test@somefoo.com, rfc822name=test@somefoo.com,"
                + " dnsname=test.primekey.se, Upn=test12@primekey.se,"
                + " ipaddress=11.11.1.2",
            "",
            "test@test.com",
     ...
     // New profile
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            "username",
            "password",
            "CN=John Smith,OU=,OU=DEP1_1,OU=,OU=DEP2_2,C=SE",
            "null",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
        ...
        fail(
            "Error Required OU fields wasn't checked propertly: "
                + e.getMessage());
      }
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            "username",
            "password",
            "CN=John Smith,OU=,OU=DEP1_1,OU=,OU=DEP2_2,OU=DEP3_3,C=SE",
            "null",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            "username",
            "password",
            "CN=John Smith,OU=,OU=DEP1_1,OU=,OU=DEP2_2,OU=DEP3_1,C=SE",
            "null",
            "",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
      ...
      // OU1=Modifyable not required, OU3=required {hard,soft}, C=O{SE,DK} not
      // required
      profile.addField(DnComponents.ORGANIZATIONALUNIT);
      profile.addField(DnComponents.ORGANIZATIONALUNIT);
      profile.addField(DnComponents.ORGANIZATIONALUNIT);
      ...
      try {
        ...
        fail(
            "Error Reverse OU fields wasn't checked propertly: "
                + e.getMessage());
      }
      ...
      // Test that the right data is checked when a lesser number of field is
      // used
      ...
      // Set so CN=modifyable required, OU=Modifyable not required,
      // OU1=Modifyable not required, OU3=required {hard,soft}, C=O{SE,DK} not
      // required
      profile.addField(DnComponents.IPADDRESS);
      profile.addField(DnComponents.IPADDRESS);
      ...
      try {
        ...
        fail(
            "Error Reverse IPADDRESS fields wasn't checked propertly: "
                + e.getMessage());
      }
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "CN=John Smith,OU=HARD,C=SE",
            "dnsname=test1.se,ipaddress=10.1.1.1",
            "CountryOfCitizenship=SE, CountryOfResidence=Foo",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
            false,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "CN=John Smith,OU=HARD,C=SE",
            "dnsname=test1.se,ipaddress=10.1.1.1",
            "CountryOfCitizenship=SE, CountryOfResidence=TR",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
            false,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "CN=John Smith,OU=HARD,C=SE",
            "dnsname=test1.se,ipaddress=10.1.1.1",
            "CountryOfCitizenship=SE, CountryOfResidence=SE, Gender=M,"
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "CN=John Smith,OU=HARD,C=SE",
            "dnsname=test1.se,ipaddress=10.1.1.1",
            "DateOfBirth=189901, CountryOfCitizenship=SE,"
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "CN=John Smith,OU=HARD,C=SE",
            "dnsname=test1.se,ipaddress=10.1.1.1",
            "DateOfBirth=189901AA, CountryOfCitizenship=SE,"
                + " CountryOfResidence=SE",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
      ...
      try {
        profile.doesUserFulfillEndEntityProfile(
            ...
            "CN=John Smith,OU=HARD,C=SE",
            "dnsname=test1.se,ipaddress=10.1.1.1",
            "DateOfBirth=18990101, CountryOfCitizenship=SE,"
                + " CountryOfResidence=SE",
            "",
            CertificateProfileConstants.CERTPROFILE_FIXED_ENDUSER,
            false,
      ...
      if (magicDateTime != magicDateTime2) {
        fail(
            "Error: Java does not parse dates correctly. "
                + magicDateTime
                + " "
                + magicDateTime2
                + " "
 ...
 * @throws Exception fail*/
  ...
  public void testfulfillEndEntityProfilesAvailableCAs() throws Exception {
    ...
    try {
      ...
      assertEquals(
          "Couldn't find CA (3) among End Entity Profiles Available CAs.",
          e.getMessage());
    }
