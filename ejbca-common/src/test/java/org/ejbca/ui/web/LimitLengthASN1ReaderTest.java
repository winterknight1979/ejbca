...
public class LimitLengthASN1ReaderTest {
   ...
   */
  private static final int[] VALID_STREAM = {
    BERTags.SEQUENCE,
    108,
    48,
    106,
   ...
   * connection.
   */
  private static final int[] FINITE_STREAM_TOO_SHORT = {
    BERTags.SEQUENCE,
    108,
    48,
    106,
  ...
  public void testReadFirstASN1ObjectNotASequence() throws IOException {
    ...
    limitLengthASN1Reader =
        new LimitLengthASN1Reader(
            inputStreamStub, NOT_A_SEQUENCE_STREAM.length);
    try {
  ...
  /**
   * Tries to process a stream with size larger than specified limit. Sending a
   * stream of infinite length may be part of a DOS attack.
   */
  @Test
   ...
   */
  @Test
  public void testReadFirstASN1ObjectUndefinedLengthHappyPath()
      throws MalformedRequestException, IOException {
  ...
  /**
   * Test readFirstASN1Object() with a stream where there is no defined ASN1
   * object length and content is invalid.
   *
   * @throws MalformedRequestException Fail
   * @throws IOException Fail
   */
  @Test
  public void
      testReadFirstASN1ObjectUndefinedLengthAndInvalidContentLengthHappyPath()
          throws MalformedRequestException, IOException {
    inputStreamStub = new InputStreamStub(UNDEFINED_LENGTH_HAPPY);
   ...
   * output.
   *
   * <p>TODO: When our test runner is reformed to only run tests matching
