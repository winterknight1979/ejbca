...
/**
 * Class Holding cache variable for available custom certificate extensions
 * configuration.
 *
 * <p>Needed because EJB spec does not allow volatile, non-final fields in
 * session beans.
 *
 * @version $Id: AvailableCustomCertificateExtensionsConfigurationCache.java
 *     22740 2016-02-05 13:28:45Z mikekushner $
 */
public class AvailableCustomCertificateExtensionsConfigurationCache
    implements ConfigurationCache {

  /**
   * Cache variable containing the available custom certificate extensions
   * configuration. This cache may be unsynchronized between multiple instances
   * of EJBCA, but is common to all threads in the same VM. Set volatile to make
   * it thread friendly.
   */
