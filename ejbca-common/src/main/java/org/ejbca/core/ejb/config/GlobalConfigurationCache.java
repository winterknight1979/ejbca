...
/**
 * Class Holding cache variable for global configuration. Needed because EJB
 ...
 *
 * @version $Id: GlobalConfigurationCache.java 22740 2016-02-05 13:28:45Z
 *     mikekushner $
 */
public final class GlobalConfigurationCache implements ConfigurationCache {
  ...
  /**
   * help variable used to control that GlobalConfiguration update isn't
   * performed to often.
   */
