 ...
 *
 * @see <a
 *     href="http://developer.java.sun.com/developer/restricted/patterns/ServiceLocator.html">Service
 *     Locator</a>
 *     <p>It is used to look up JNDI related resources such as EJB homes,
 *     datasources, ...
...
public final class ServiceLocator {
   ...
   * @throws ServiceLocatorException if the lookup fails
   */
  public boolean getBoolean(final String envName)
      throws ServiceLocatorException {
  ...
  public String getString(final String envName) throws ServiceLocatorException {
    ...
    try {
      ...
      if (e.getCause() instanceof NameNotFoundException) {
        // ignore this and return null, otherwise we can not have empty values
        // in Glassfish
        ret = null;
      }
    }
   ...
   * @throws ServiceLocatorException if the lookup fails
   */
  public Session getMailSession(final String envName)
      throws ServiceLocatorException {
