...
/**
 * Class Holding cache variable for cmp configuration. Needed because EJB spec
 ...
 *
 * @version $Id: CMPConfigurationCache.java 22740 2016-02-05 13:28:45Z
 *     mikekushner $
 */
public final class CMPConfigurationCache implements ConfigurationCache {
  ...
  /**
   * help variable used to control that CmpConfiguration update isn't performed
   * to often.
   */
