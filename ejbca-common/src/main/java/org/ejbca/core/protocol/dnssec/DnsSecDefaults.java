 ...
 * Defaults for DNSSEC.
 *
 * @version $Id: DnsSecDefaults.java 29945 2018-10-02 06:23:26Z samuellb $
 */
public final class DnsSecDefaults {
  ...
  /**
   * Default root anchors for DNSSEC from IANA. Defined in
   * https://data.iana.org/root-anchors/root-anchors.xml
   *
   * <p>In the long run we should consider:
   *
   * <ol>
  ...
  public static final String IANA_ROOT_ANCHORS_DEFAULT =
      ". IN DS 19036 8 2"
          ...
          ". IN DS 20326 8 2"
        + " E06D44B80B8F1D39A95C0B0D7C65D08458E880409BBC683457104237C7F8EC8D"; // new key, valid from 2018-10-11
}
