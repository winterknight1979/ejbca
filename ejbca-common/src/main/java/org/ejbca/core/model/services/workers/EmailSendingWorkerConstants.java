...
/**
 * @version $Id: EmailSendingWorkerConstants.java 22117 2015-10-29 10:53:42Z
 *     mikekushner $
 */
public abstract class EmailSendingWorkerConstants {
  ...
  /**
   * The message to use in the end user notification. Substitution variables are
   * possible in the same way as for regular notifications.
   */
  ...
  /**
   * The message to use in the admin notification. Substitution variables are
   * possible in the same way as for regular notifications.
   */
