...
public abstract class AccessRulesConstants {
  ...
  public static final String REGULAR_PEERCONNECTOR_INVOKEAPI =
      "/ra_master/invoke_api"; // org.ejbca.peerconnector.PeerRaAccessRules.RA_MASTER_INVOKE_API
  ...
  public static final String REGULAR_PEERPROTOCOL_WS =
      "/protocol/web_services"; // org.ejbca.peerconnector.PeerProtocolAccessRules.WS
