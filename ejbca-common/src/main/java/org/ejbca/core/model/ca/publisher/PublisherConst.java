...
/**
 * Constants for Publishers. Constants for Type of publisher: Type is
 * constructed as a mask since one publisher can be of several types.
 *
 * @version $Id: PublisherConst.java 30137 2018-10-18 08:07:23Z samuellb $
 */
public final class PublisherConst {

  private PublisherConst() { }
   ...
   */
  @Deprecated public static final int TYPE_VAPUBLISHER = 5;
  ...
  public static final int STATUS_SUCCESS =
      10; // If the entry has been published successfully
  ...
  public static final int STATUS_FAILED =
      30; // If publishing failed completely so we will not try again

  /** A certificate published. */
  public static final int PUBLISH_TYPE_CERT =
      1; // Is it a certificate we publish
