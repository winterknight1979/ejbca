 ...
 *
 * @version $Id: UserDataSourceConnectionException.java 22117 2015-10-29
...
public class UserDataSourceConnectionException extends EjbcaException {
  ...
  /**
   * Creates a new instance of <code>UserDataSourceConnectionException</code>
  ...
  /**
   * Constructs an instance of <code>UserDataSourceConnectionException</code>
   * with the specified detail message.
   *
   * @param msg the detail message.
   */
  public UserDataSourceConnectionException(final String msg) {
    super(msg);
  }
}
