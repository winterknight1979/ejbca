 ...
 * custom user data source. All Custom user data sources must implement this
 * interface.
 *
 * @version $Id: ICustomUserDataSource.java 22117 2015-10-29 10:53:42Z
 *     mikekushner $
 */
public interface ICustomUserDataSource {

  /**
   * Method called to all newly created IUserDataSource to set it up with saved
   * configuration.
   *
