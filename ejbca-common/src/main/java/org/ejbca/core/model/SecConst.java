 ...
 * generated.
 *
 * @version $Id: SecConst.java 27422 2017-12-05 14:05:42Z bastianf $
 */
public final class SecConst {
  ...
  /**
   * Constant indicating a eid hard token. OBSERVE This class should only be
   * used for backward compatibility with EJBCA 2.0
   */
   ...
   * when lookup of available bit lengths fails. see
   * org.ejbca.ui.web.pub.ApplyBean in publicweb-gui
   */
