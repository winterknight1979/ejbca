...
/**
 * An exception thrown when someone tries to remove or change a hard token that
 * doesn't exits.
 *
 * @author Philip Vendil 2003-01-20
 * @version $Id: HardTokenDoesntExistsException.java 22117 2015-10-29 10:53:42Z
 *     mikekushner $
 */
@WebFault
public class HardTokenDoesntExistsException extends java.lang.Exception {
  ...
  /**
   * Creates a new instance of <code>HardTokenDoesntExistsException</code>
  ...
  /**
   * Constructs an instance of <code>HardTokenDoesntExistsException</code> with
