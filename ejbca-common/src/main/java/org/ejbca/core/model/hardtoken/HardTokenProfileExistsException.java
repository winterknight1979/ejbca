...
public class HardTokenProfileExistsException extends java.lang.Exception {
  ...
  /**
   * Creates a new instance of <code>HardTokenProfileExistsException</code>
  ...
  /**
   * Constructs an instance of <code>EHardTokenProfileExistsException</code>
   * with the specified detail message.
   *
   * @param msg the detail message.
   */
  public HardTokenProfileExistsException(final String msg) {
    super(msg);
  }
}
