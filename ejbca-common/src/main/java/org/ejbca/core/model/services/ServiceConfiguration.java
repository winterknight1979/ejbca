 ...
 */
public class ServiceConfiguration extends UpgradeableDataHashMap
  ...
  public void setActionClassPath(final String actionClassPath) {
  ...
  public void setActionProperties(final Properties actionProperties) {
  ...
  public void setIntervalClassPath(final String intervalClassPath) {
  ...
  public void setIntervalProperties(final Properties intervalProperties) {
  ...
  public void setWorkerClassPath(final String workerClassPath) {
  ...
  public void setWorkerProperties(final Properties workerProperties) {
  ...
  public void upgrade() {
    if (Float.compare(LATEST_VERSION, getVersion()) > 0) {
      ...
      if (Float.compare(Float.valueOf(2), getVersion()) > 0) { // v2
        ...
        if (prop != null) {
          String caids =
              prop.getProperty("worker.emailexpiration.caidstocheck");
          String timebeforexpire =
              prop.getProperty("worker.emailexpiration.timebeforeexpiring");
          String timeunit = prop.getProperty("worker.emailexpiration.timeunit");
          String sendtousers =
              prop.getProperty("worker.emailexpiration.sendtoendusers");
          String sendtoadmins =
              prop.getProperty("worker.emailexpiration.sendtoadmins");
          String usersubject =
              prop.getProperty("worker.emailexpiration.usersubject");
          String usermessage =
              prop.getProperty("worker.emailexpiration.usermessage");
          String adminsubject =
              prop.getProperty("worker.emailexpiration.adminsubject");
          String adminmessage =
              prop.getProperty("worker.emailexpiration.adminmessage");
          ...
          if (sendtousers != null) {
            prop.setProperty(
                EmailSendingWorkerConstants.PROP_SENDTOENDUSERS, sendtousers);
            prop.remove("worker.emailexpiration.sendtoendusers");
          }
          if (sendtoadmins != null) {
            prop.setProperty(
                EmailSendingWorkerConstants.PROP_SENDTOADMINS, sendtoadmins);
            prop.remove("worker.emailexpiration.sendtoadmins");
          }
          if (usersubject != null) {
            prop.setProperty(
                EmailSendingWorkerConstants.PROP_USERSUBJECT, usersubject);
            prop.remove("worker.emailexpiration.usersubject");
          }
          if (usermessage != null) {
            prop.setProperty(
                EmailSendingWorkerConstants.PROP_USERMESSAGE, usermessage);
        ...
        if (Float.compare(Float.valueOf(4), getVersion()) > 0) { // v4
          ...
          // check if the service is upgraded
        }
      }
