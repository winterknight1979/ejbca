...
/**
 * Class representing an approval of a request. Includes information like:
 * Approval admin certificate isApproved (rejected otherwise) ApprovalDate
 * Comment
 *
 * <p>Approvals are sorted by dates.
 *
 * @version $Id: Approval.java 26224 2017-08-04 15:11:12Z mikekushner $
 */

// Suppress warnings for deprecation of the Admin object, required for legacy
// support
    ...
    if (version == 1) {
      ...
      if (this.admin instanceof LocalJvmOnlyAuthenticationToken) {
        LocalJvmOnlyAuthenticationToken localToken =
            (LocalJvmOnlyAuthenticationToken) this.admin;
