...
/**
 * Represents a partition of an approval sequence. Each sequence consists of one
 * or more partitions, which have to all be evaluated before the sequence can
 * pass.
 *
 * @version $Id: ApprovalPartition.java 24958 2016-12-28 17:07:58Z mikekushner $
 */
 ...
 */
  public LinkedHashMap<String, DynamicUiProperty<? extends Serializable>>
    ...
    final LinkedHashMap<String, DynamicUiProperty<? extends Serializable>> ret =
        new LinkedHashMap<String, DynamicUiProperty<? extends Serializable>>();
