...
/**
 * IPasswordGenerator is an interface used to generate passwords used by end
 * entities in EJBCA. Usage:
 *
 * <pre>
...
public interface IPasswordGenerator {
  ...
  /**
   * Method generating a new password for the user and returns a string
