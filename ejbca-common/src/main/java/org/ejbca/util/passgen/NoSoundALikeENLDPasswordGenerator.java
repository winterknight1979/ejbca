...
/**
 * This class allows all letters and digits except those that sound similar in
 * english like aj and eg.
 *
 * @version $Id: NoSoundALikeENLDPasswordGenerator.java 22117 2015-10-29
...
public class NoSoundALikeENLDPasswordGenerator extends BasePasswordGenerator {
  ...
  private static final char[] USEDCHARS = {
    '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'q', 'Q', 'w', 'W', 'r',
    'R', 't', 'T', 'y', 'Y', 'u', 'U', 'i', 'I', 'o', 'O', 'p', 'P', 's', 'S',
    'd', 'D', 'f', 'F', 'h', 'H', 'k', 'K', 'l', 'L', 'z', 'Z', 'x', 'X', 'c',
    'C', 'v', 'V', 'b', 'B', 'n', 'N', 'm', 'M'
  };
