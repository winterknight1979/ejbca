...
public class Log4jHandler extends Handler {
  ...
  private org.apache.log4j.Level translateLevel(final Level level) {
  ...
  public void publish(final LogRecord record) {
    final org.apache.log4j.Logger logger =
        org.apache.log4j.Logger.getLogger(record.getSourceClassName());
    ...
    logger.log(
        Log4jHandler.class.getCanonicalName(),
