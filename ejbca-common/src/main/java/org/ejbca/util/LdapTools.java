 ...
 *
 * @version $Id: LdapTools.java 22117 2015-10-29 10:53:42Z mikekushner $
 */
public final class LdapTools {
   ...
   * @return all intermediate DNs in a given DN under a base DN, in the order
   *     from the first one below the base DN and further down.
   */
  public static List<String> getIntermediateDNs(
    ...
    for (int start = components.size() - 1; start >= 0; start--) {
      final List<String> intermComps =
          components.subList(start, components.size());
