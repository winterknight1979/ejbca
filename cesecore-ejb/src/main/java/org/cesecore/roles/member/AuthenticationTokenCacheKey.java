 ...
 *
 * @version $Id: AuthenticationTokenCacheKey.java 26457 2017-08-29 08:12:10Z
 *     mikekushner $
 */
public class AuthenticationTokenCacheKey {
  ...
  public AuthenticationTokenCacheKey(
    ...
    if (preferredMatchKey != AuthenticationToken.NO_PREFERRED_MATCH_KEY) {
      List<AccessMatchType> accessMatchType =
          authenticationToken
              .getMetaData()
  ...
  public AuthenticationTokenCacheKey(
    ...
    preferredTokenMatchValue =
        authenticationTokenCacheKey.preferredTokenMatchValue;
  }
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((preferredTokenMatchValue == null)
                ? 0
                : preferredTokenMatchValue.hashCode());
  ...
  public boolean equals(final Object obj) {
    ...
    } else if (!preferredTokenMatchValue.equals(
        other.preferredTokenMatchValue)) {
      return false;
    }
    if (tokenType == null) {
