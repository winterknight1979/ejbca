 ...
 * sequential updates.
 *
 * @version $Id: CaIDCacheBean.java 27090 2017-11-08 12:18:08Z anatom $
 */
@Singleton
@Startup
...
public class CaIDCacheBean {
  ...
  /**
   * Fetch all CA IDs from the database, unless cache is enabled, valid and we
  ...
  private List<Integer> findAllCaIds() {
    final Query query =
        entityManager.createQuery("SELECT a.caId FROM CAData a");
