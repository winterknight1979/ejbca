 ...
 * holds the variable isUniqueCertificateSerialNumberIndex, which is initialized
 * by calling, once (or several times)
 * CertificateStoreSessionLocal.checkForUniqueCertificateSerialNumberIndex().
 * Actually calling this method only does something once, called several times
 * does nothing and does not change any values returned by
