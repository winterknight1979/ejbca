 ...
 *
 * @version $Id: KeyValidatorCacheTest.java 26329 2017-08-16 15:06:47Z
 *     mikekushner $
 */
public class KeyValidatorCacheTest {
  ...
  public void disabledCacheBehavior() {
    ...
    assertEquals(
        ...
        0,
        ValidatorCache.INSTANCE.getNameToIdMap().entrySet().size());
    assertNull(
        "Empty cache returned an entry anyway.",
        ValidatorCache.INSTANCE.getEntry(1));
    assertNull(
        "Empty cache returned an entry anyway.",
        ValidatorCache.INSTANCE.getEntry(1));
    assertNull(
    ...
    assertTrue(
        ...
        ValidatorCache.INSTANCE.shouldCheckForUpdates(1));
    assertTrue(
        "Cache indicated that non-existing object is valid.",
        ValidatorCache.INSTANCE.shouldCheckForUpdates(2));
    assertTrue(
        "Cache indicated that non-existing object is valid.",
        ValidatorCache.INSTANCE.shouldCheckForUpdates(3));
    assertNull(
        "Empty cache returned a name anyway",
        ValidatorCache.INSTANCE.getName(1));
    assertNull(
        "Empty cache returned a name anyway",
        ValidatorCache.INSTANCE.getName(2));
    assertNull(
        "Empty cache returned a name anyway",
    ...
    assertNull(
        "Empty cache returned an entry anyway.",
        ValidatorCache.INSTANCE.getEntry(2));
    assertNull(
        "Empty cache returned an entry anyway.",
        ValidatorCache.INSTANCE.getEntry(3));
    assertTrue(
        "Cache indicated that non-existing object is valid.",
        ValidatorCache.INSTANCE.shouldCheckForUpdates(1));
    assertTrue(
  ...
  public void enabledCacheBehavior() {
    ...
    assertEquals(
        ...
        1,
        ValidatorCache.INSTANCE.getNameToIdMap().get(name1).intValue());
    assertEquals(
        "Wrong mapping for name.",
        2,
        ValidatorCache.INSTANCE.getNameToIdMap().get(name2).intValue());
    assertEquals(
        "Wrong mapping for name.",
        3,
        ValidatorCache.INSTANCE.getNameToIdMap().get(name3).intValue());
    assertEquals(
    ...
    assertFalse(
        ...
        ValidatorCache.INSTANCE.shouldCheckForUpdates(3));
    assertEquals(
        "Wrong mapping for name", name1, ValidatorCache.INSTANCE.getName(1));
    assertEquals(
        "Wrong mapping for name", name2, ValidatorCache.INSTANCE.getName(2));
    assertEquals(
        "Wrong mapping for name", name3, ValidatorCache.INSTANCE.getName(3));
    ...
    assertEquals(
        "Wrong mapping for name", name1, ValidatorCache.INSTANCE.getName(1));
    assertEquals(
        "Wrong mapping for name", name3, ValidatorCache.INSTANCE.getName(2));
    assertEquals(
        "Wrong mapping for name", name2, ValidatorCache.INSTANCE.getName(3));
    // Notify cache that the objects should be removed from the cache
    ValidatorCache.INSTANCE.updateWith(1, 1, null, null);
    ValidatorCache.INSTANCE.updateWith(2, 1, null, keyValidator2);
    ValidatorCache.INSTANCE.updateWith(3, 1, name3, null);
