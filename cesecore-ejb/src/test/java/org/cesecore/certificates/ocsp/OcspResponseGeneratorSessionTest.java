 ...
 *
 * @version $Id: OcspResponseGeneratorSessionTest.java 26279 2017-08-12
 *     08:47:06Z anatom $
 */
  ...
  public void testWithRandomBytes()
    ...
    TransactionLogger transactionLogger =
        new TransactionLogger(
            localTransactionId, GuidHolder.INSTANCE.getGlobalUid(), "");
    ...
    try {
      ocspResponseGeneratorSession.getOcspResponse(
          fakeRequest, null, null, null, null, auditLogger, transactionLogger);
    } catch (MalformedRequestException e) {
      caught = true;
    }
    assertTrue(
        "MalformedRequestException was not thrown for a request > 100000"
            + " bytes.",
        caught);
  }
