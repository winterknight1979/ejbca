...
public class CommandLibraryTest {
    ...
    public void setup() throws IOException {
    	...
    	// TODO : use a java agent to replace this hack, which no longer works under JDK 11.
    	// until that's done we disable these tests
    	// see : https://github.com/CGJennings/jar-loader/blob/master/src/ca/cgjennings/jvm/JarLoader.java
