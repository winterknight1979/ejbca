...
public class EnrollMakeNewRequestBean implements Serializable {
  ...
  public void setRenderCsrDetailedInfo(final boolean renderCsrDetailedInfo) {
  ...
  private byte[] addEndEntityAndGenerateToken(
    ...
    endEntityInformation.setCertificateProfileId(
        authorizedCertificateProfiles
            .get(Integer.parseInt(getSelectedCertificateProfile()))
            .getId());
    endEntityInformation.setDN(getSubjectDn().toString());
    endEntityInformation.setEndEntityProfileId(
  ...
  public final void checkSubjectDn() {
    try {
      ...
      raMasterApiProxyBean.checkSubjectDn(
          raAuthenticationBean.getAuthenticationToken(), endEntityInformation);
    } catch (AuthorizationDeniedException e) {
      log.error(e);
    } catch (EjbcaException e) {
      if (ErrorCode
  ...
  public void setRenderNonModifiableTemplates(
      final boolean renderNonModifiableTemplates) {
  ...
  public void setRenderNonModifiableFields(
      final boolean renderNonModifiableFields) {
  ...
  public void setSelectedEndEntityProfile(
      final String selectedEndEntityProfile) {
    if (!StringUtils.equals(
        selectedEndEntityProfile, this.selectedEndEntityProfile)) {
  ...
  public void setSelectedCertificateProfile(
      final String selectedCertificateProfile) {
    if (!StringUtils.equals(
        selectedCertificateProfile, this.selectedCertificateProfile)) {
    ...
    if (this.availableAlgorithmSelectItems == null) {
      ...
      if (certificateProfile != null) {
        ...
        if (availableAlgorithmSelectItems.size() > 1
            && StringUtils.isEmpty(
                getSelectedAlgorithm(availableAlgorithmSelectItems))) {
          availableAlgorithmSelectItems.add(
              new SelectItem(
                  null,
  ...
  private String getSelectedAlgorithm(
    ...
    if (availableAlgorithmSelectItems.size() == 1) {
      selectedAlgorithm =
          String.valueOf(availableAlgorithmSelectItems.get(0).getValue());
    }
  ...
  public void setSelectedCertificateAuthority(
      final String selectedCertificateAuthority) {
    if (StringUtils.isNotEmpty(selectedCertificateAuthority)) {
  ...
  public void setSha256Fingerprint(final String sha256Fingerprint) {
  ...
  public void setCsrFileName(final String csrFileName) {
  ...
  public void setUserCredentialsMessagesComponent(
      final UIComponent userCredentialsMessagesComponent) {
  ...
  public void setSubjectDnMessagesComponent(
      final UIComponent subjectDnMessagesComponent) {
  ...
  public void setConfirmPasswordComponent(
      final UIComponent confirmPasswordComponent) {
  ...
  public void setValidityInputComponent(
      final UIComponent validityInputComponent) {
